...
static struct gpiomux_setting cam_settings[] = {
	...
	{
		.func = GPIOMUX_FUNC_1, /*active 3*/		/* camera_rupy */
		.drv = GPIOMUX_DRV_8MA,
		.pull = GPIOMUX_PULL_NONE,
	},
	...
	{
		.func = GPIOMUX_FUNC_GPIO, /*active 13*/		/* camera_rupy */
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_NONE,
		.dir = GPIOMUX_OUT_HIGH,
	},
	{
		.func = GPIOMUX_FUNC_GPIO, /*suspend 14*/
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_NONE,
		.dir = GPIOMUX_OUT_LOW,
	},
...
static struct camera_vreg_t apq_8064_back_cam_vreg[] = {
	{"cam_8921_S8", REG_LDO, 2200000, 2200000, 100000},
	{"cam_vdig", REG_LDO, 1200000, 1200000, 100000},
	{"cam_vio", REG_VS, 1800000, 1800000, 100000},
	{"cam_vana", REG_LDO, 2700000, 2700000, 100000},
	{"cam_vaf", REG_LDO, 2700000, 2700000, 100000},
};
...
static struct gpio apq8064_back_cam_gpio[] = {
	...
	{86, GPIOF_DIR_OUT, "CAM_RESET"},
	{1, GPIOF_DIR_OUT, "V12CAM_EN"},
	{2, GPIOF_DIR_OUT, "V11CAM_EN"},
	{34, GPIOF_DIR_IN, "CAM_INT"},
};

static struct msm_gpio_set_tbl apq8064_back_cam_gpio_set_tbl[] = {
	{1, GPIOF_OUT_INIT_HIGH, 0},
	{2, GPIOF_OUT_INIT_HIGH, 0},
};
...
#if 0	/* camera_rupy  TODO not used */
...
#if 1		/* camera_rupy */
	{
		I2C_BOARD_INFO("imx135", 0x60),
		.platform_data = &msm_camera_sensor_imx135_data,
	},
	{
		I2C_BOARD_INFO("imx119", 0x61),
