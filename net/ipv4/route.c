...
/* PMC-Viana-xxx-NEMO‘g‚Ýž‚Ý‘Î‰ž(Žb’è) add start */
struct rtable *ip_route_output_key_viana(struct net *net, struct flowi4 *flp)
{
	return ip_route_output_flow(net, flp, NULL);
}

EXPORT_SYMBOL(ip_route_output_key_viana);
/* PMC-Viana-xxx-NEMO‘g‚Ýž‚Ý‘Î‰ž(Žb’è) add end */
