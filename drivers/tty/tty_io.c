...
// <iDPower_002> add S
#define __PANASONIC_VENDOR_CODE__
// <iDPower_002> add E
...
// <iDPower_002> mod S
#ifdef __PANASONIC_VENDOR_CODE__
...
#ifdef __PANASONIC_VENDOR_CODE__
int tty_open(struct inode *, struct file *);
#else
 static int tty_open(struct inode *, struct file *);
#endif
// <iDPower_002> mod E
...
// <iDPower_002> add S
	if (strcmp(driver->name, "felica") == 0)
		sprintf(p, "%s", driver->name);
// <iDPower_002> add E
}
