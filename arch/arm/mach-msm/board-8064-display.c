...
#define MIPI_VIDEO_TMD_HD_PANEL_NAME    "mipi_video_sharp_hd"
...
static int msm_fb_detect_panel(const char *name)
{
        ...
        if (!strncmp(name, MIPI_VIDEO_TMD_HD_PANEL_NAME,
                        strnlen(MIPI_VIDEO_TMD_HD_PANEL_NAME,
                                PANEL_NAME_MAX_LEN)))
                return 0;
#else
	u32 version;
...
static struct msm_bus_vectors mdp_ui_vectors[] = {
	{
		.src = MSM_BUS_MASTER_MDP_PORT0,
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab  = 0x76A7005A,	/* 1,990,656,090 */
		.ib  = 0xB1FA8087,	/* 2,985,984,135 */
	},
};
	...
	/* VGA and less video */
        {
                .src = MSM_BUS_MASTER_MDP_PORT0,
                .dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab  = 0x784CE000,	/* 2,018,304,000 */
		.ib  = 0xB4735000,	/* 3,027,456,000 */
        },
};
	...
	/* 720p and less video */
        {
                .src = MSM_BUS_MASTER_MDP_PORT0,
                .dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab  = 0x7B98A000,	/* 2,073,600,000 */
		.ib  = 0xB964F000,	/* 3,110,400,000 */
        },
};
	...
	/* 1080p and less video */
        {
                .src = MSM_BUS_MASTER_MDP_PORT0,
                .dst = MSM_BUS_SLAVE_EBI_CH0,
                .ab  = 0x81C6A800,	/* 2,177,280,000 */
                .ib  = 0xC2A9FC00,	/* 3,265,920,000 */
        },
};

#ifdef CONFIG_FB_MSM_MIPI_DSI_TMD		/* BUS_BW_CUSTOM */
static struct msm_bus_vectors mdp_bus_bw_table7_vectors[] = {
	/* bus bw 700MHz */
	{
		.src = MSM_BUS_MASTER_MDP_PORT0,
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab  = 0x29B92700,	/* 700,000,000  ( = 700 x 1000 x 1000 ) */
		.ib  = 0x342770C0,	/* 875,000,000 ( = ab x 1.25 ) */
        },
};
static struct msm_bus_vectors mdp_bus_bw_table6_vectors[] = {
	/* bus bw 850MHz */
	{
		.src = MSM_BUS_MASTER_MDP_PORT0,
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab  = 0x32A9F880,	/* 850,000,000 ( = 850 x 1000 x 1000 ) */
		.ib  = 0x3F5476A0,	/* 1,062,500,000 ( = ab x 1.25 ) */
	},
};
static struct msm_bus_vectors mdp_bus_bw_table5_vectors[] = {
	/* bus bw 1200MHz */
	{
		.src = MSM_BUS_MASTER_MDP_PORT0,
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab  = 0x47868C00,	/* 1,200,000,000 ( = 1200 x 1000 x 1000 ) */
		.ib  = 0x59682F00,	/* 1,500,000,000 ( = ab x 1.25 ) */
	},
};
static struct msm_bus_vectors mdp_bus_bw_table4_vectors[] = {
	/* bus bw 1700MHz */
	{
		.src = MSM_BUS_MASTER_MDP_PORT0,
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab  = 0x6553F100,	/* 1,700,000,000 ( = 1700 x 1000 x 1000 ) */
		.ib  = 0x7EA8ED40,	/* 2,125,000,000 ( = ab x 1.25 ) */
	},
};
static struct msm_bus_vectors mdp_bus_bw_table3_vectors[] = {
	/* bus bw 2000MHz */
	{
		.src = MSM_BUS_MASTER_MDP_PORT0,
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab  = 0x77359400,	/* 2,000,000,000 ( = 2000 x 1000 x 1000 ) */
		.ib  = 0x9502F900,	/* 2,500,000,000 ( = ab x 1.25 ) */
	},
};
static struct msm_bus_vectors mdp_bus_bw_table2_vectors[] = {
	/* bus bw 2500MHz */
	{
		.src = MSM_BUS_MASTER_MDP_PORT0,
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab  = 0x9502F900,	/* 2,500,000,000 ( = 2500 x 1000 x 1000 ) */
		.ib  = 0xBA43B740,	/* 3,125,000,000 ( = ab x 1.25 ) */
	},
};
static struct msm_bus_vectors mdp_bus_bw_table1_vectors[] = {
	/* bus bw 3000MHz */
	{
		.src = MSM_BUS_MASTER_MDP_PORT0,
		.dst = MSM_BUS_SLAVE_EBI_CH0,
		.ab  = 0xB2D05E00,	/* 3,000,000,000 ( = 2500 x 1000 x 1000 ) */
		.ib  = 0xDF847580,	/* 3,750,000,000 ( = ab x 1.25 ) */
	},
};
...
static struct msm_bus_paths mdp_bus_scale_usecases[] = {
...
#ifdef CONFIG_FB_MSM_MIPI_DSI_TMD			/* BUS_BW_CUSTOM */
	{
		ARRAY_SIZE(mdp_bus_bw_table7_vectors),
		mdp_bus_bw_table7_vectors,
	},
	{
		ARRAY_SIZE(mdp_bus_bw_table7_vectors),
		mdp_bus_bw_table7_vectors,
	...
	{
		ARRAY_SIZE(mdp_bus_bw_table6_vectors),
		mdp_bus_bw_table6_vectors,
	},
	{
		ARRAY_SIZE(mdp_bus_bw_table5_vectors),
		mdp_bus_bw_table5_vectors,
	},
	{
		ARRAY_SIZE(mdp_bus_bw_table4_vectors),
		mdp_bus_bw_table4_vectors,
	},
	{
		ARRAY_SIZE(mdp_bus_bw_table3_vectors),
		mdp_bus_bw_table3_vectors,
	},
	{
		ARRAY_SIZE(mdp_bus_bw_table2_vectors),
		mdp_bus_bw_table2_vectors,
	},
	{
		ARRAY_SIZE(mdp_bus_bw_table1_vectors),
		mdp_bus_bw_table1_vectors,
	},
...
#endif // #ifdef CONFIG_FB_MSM_WRITEBACK_MSM_PANEL
...
#ifndef CONFIG_FB_MSM_MIPI_DSI_TMD
...
#ifdef CONFIG_FB_MSM_MIPI_DSI_TMD
#define LPM_CHANNEL_BACKLIGHT 2
static int sharp_gpio[] = {
			LPM_CHANNEL_BACKLIGHT,
			PM8921_GPIO_PM_TO_SYS(16), /* LCD DCDC */
			PM8921_GPIO_PM_TO_SYS(17), /* LCD LDO  */
//			PM8921_GPIO_PM_TO_SYS(43), /* RESET    */
			PM8921_GPIO_PM_TO_SYS(25), /* RESET    */
			};

static struct mipi_dsi_panel_platform_data sharp_pdata = {
	.gpio = sharp_gpio,
};
...
{
	printk(KERN_ERR "#######  apq8064_init_fb TOP ##########\n");
	...
	printk(KERN_ERR "#######  apq8064_init_fb END ##########\n");
}
