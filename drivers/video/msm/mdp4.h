...
enum {
	...
	OVERLAY_PERF_LEVEL5,
	OVERLAY_PERF_LEVEL6,
	OVERLAY_PERF_LEVEL_MIN,
};
#define OVERLAY_BUS_SCALE_TABLE_BASE	9					/* number of element [mdp_bus_scale_usecases] */
#define OVERLAY_BUS_SCALE_TABLE_MAX	(OVERLAY_BUS_SCALE_TABLE_BASE - 1)	/* max index of [mdp_bus_scale_usecases] */
...
void mdp4_overlay_mdp_perf_req_down( struct msm_fb_data_type *mfd );		/* BUS_BW_CUSTOM */
unsigned int mdp4_calc_pipe_mdp_bw_single(struct mdp4_overlay_pipe *pipe);	/* BUS_BW_CUSTOM */
unsigned int mdp_get_bus_scale_level(unsigned int bus_bw);			/* BUS_BW_CUSTOM */
struct msm_fb_data_type * mdp4_overlay_dsi_video_get_mfd(void);			/* BUS_BW_CUSTOM */
