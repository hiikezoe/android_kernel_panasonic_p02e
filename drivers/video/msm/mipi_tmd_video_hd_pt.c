...
static int __init mipi_video_tmd_hd_pt_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_video_tmd_hd"))
		return 0;
	...
	pinfo.lcdc.underflow_clr = 0xffff00;	/* blue */
	pinfo.lcdc.hsync_skew = 0;
	pinfo.bl_max = MIPI_TMD_PWM_LEVEL;
	pinfo.bl_min = 1;
	pinfo.fb_num = 2;
...
#ifdef MIPI_TMD_FUMC_REFRESH_LP
	...
	ret = mipi_tmd_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_video_tmd_hd_pt_init);
