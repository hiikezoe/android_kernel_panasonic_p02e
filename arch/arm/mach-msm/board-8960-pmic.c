...
//	PM8XXX_GPIO_OUTPUT(17,	    0),			 /* DISP 3.3 V Boost */
	...
	PM8XXX_GPIO_OUTPUT_FUNC(25, 0, PM_GPIO_FUNC_NORMAL),	 /* Bl: Off, DCDC     */
	PM8XXX_GPIO_OUTPUT_VIN(16, 0, PM_GPIO_VIN_L17),	     /* LCD: DCDC         */
	PM8XXX_GPIO_OUTPUT(17, 0),	     /* LCD: LDO          */
//	PM8XXX_GPIO_OUTPUT(16, PM_GPIO_PULL_DN),	     /* LCD: DCDC         */
//	PM8XXX_GPIO_OUTPUT(17, PM_GPIO_PULL_DN),	     /* LCD: LDO          */
...
static struct pm8xxx_mpp_init pm8921_mpps[] __initdata = {
    PM8XXX_MPP_INIT(7, D_OUTPUT, PM8921_MPP_DIG_LEVEL_S4, DOUT_CTRL_LOW), /* IDPower GPIO(ISV) */
    PM8XXX_MPP_INIT(8, SINK, PM8XXX_MPP_CS_OUT_5MA, CS_CTRL_DISABLE),     /* IDPower GPIO(ISV) */
    PM8XXX_MPP_INIT(PM8XXX_AMUX_MPP_4, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH6, DOUT_CTRL_LOW), /* IDPower for SafetyIC */
};

void __init msm8960_pm8921_gpio_mpp_init(void)
{
	int i, rc;
	printk("msm8960_pm8921_gpio_mpp_init enter!! \n");
...
static const unsigned int keymap[] = {
#if defined(CONFIG_MSM8960_IDP_BRB_KEY)
	KEY(0, 0, KEY_VOLUMEUP),
	KEY(0, 1, KEY_VOLUMEDOWN),
	...
	KEY(1, 2, KEY_BACK),
	KEY(1, 3, KEY_SEARCH),
#elif defined(CONFIG_MSM8960_IDP_GB)
	KEY(0, 0, KEY_MENU),
	KEY(0, 1, KEY_BACK),
	KEY(1, 0, KEY_VOLUMEUP),
	KEY(1, 2, KEY_VOLUMEDOWN),
#elif defined(CONFIG_MSM8960_IDP_ICS)
	KEY(0, 0, KEY_VOLUMEUP),
	KEY(0, 1, KEY_VOLUMEDOWN),
#else
	KEY(0, 0, KEY_VOLUMEUP),
...
static struct pm8xxx_keypad_platform_data keypad_data = {
	...
	.input_phys_device      = "keypad_8960/input0",
#if defined(CONFIG_MSM8960_IDP_BRB_KEY) || defined(CONFIG_MSM8960_IDP_GB)
	.num_rows               = 2,
#else
	.num_rows               = 1,
#endif
...
static struct pm8921_charger_platform_data pm8921_chg_pdata __devinitdata = {
	...
	.weak_voltage	= 3000, /* npdc300035314 */
};
...
//iD POWER using pmic8921 vibrator function
static struct pm8xxx_vibrator_platform_data pm8xxx_vib_pdata __devinitdata = {
        .initial_vibrate_ms     = 0, /* IDPower npdc300020740 Stopped vibration at booting kernel */
...
static struct pm8921_platform_data pm8921_platform_data __devinitdata = {
	...
	.vibrator_pdata		= &pm8xxx_vib_pdata,  //iD POWER using pmic8921 vibrator function
};
