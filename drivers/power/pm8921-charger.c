...
/* Jessie add start */
#define PM8921_DEBUG_IT
#if defined(PM8921_DEBUG_PT)
	#include <linux/kernel.h>
	#define pm8921_dev_dbg(format, arg...) printk(format, ##arg ); mdelay(10)		// #Jessie_dbg
	#define pm8921_dev_dbg_it(format, arg...) printk(format, ##arg ); mdelay(10)	// #Jessie_dbg
#elif defined(PM8921_DEBUG_IT)
	#include <linux/kernel.h>
	#define pm8921_dev_dbg(format, arg...)
	#define pm8921_dev_dbg_it(format, arg...) printk(format, ##arg )
#else  /* PM8921_DEBUG */
	#define pm8921_dev_dbg(format, arg...)
	#define pm8921_dev_dbg_it(format, arg...)
#endif /* PM8921_DEBUG */
/* Jessie add end */
...
#include <linux/rh-fgc.h> /* IDPower */

#include <linux/io.h>
#include <linux/laputa-fixaddr.h>
#include <linux/reboot.h> /* IDPower: npdc300006191 */
/* Jessie add start */
#include <linux/gpio.h>
#include <linux/safety_ic.h>
/* Jessie add end */
#include <linux/wchg_driver.h> /* Quad add: npdc300052029, npdc300052031 */
#include <linux/time.h>	/* Quad add */

/* Jessie add start */
struct workqueue_struct *g_pm8921_wq;
/* Jessie add end */
...
#define USB_WALL_THRESHOLD_MA	500 /*<npdc300035206>*/
...
#define GPIO_WIRELESS_CHARGE_UART (10)
#define GPIO_WIRELESS_CHARGE_LED_MASK (PM8921_GPIO_PM_TO_SYS(36))
#define GPIO_WIRELESS_CHARGE_LEVEL_SHIFTER (PM8921_GPIO_PM_TO_SYS(42))	/* Quad add */
#define GPIO_WIRELESS_CHARGE_CURRENT_LIMIT (PM8921_GPIO_PM_TO_SYS(6))	/* Quad add */
#else
#define GPIO_CHG_STS (107)
#define GPIO_CHG_SUSPEND (76)
#define GPIO_WIRELESS_CHARGE_UART (18)
#define GPIO_WIRELESS_CHARGE_LED_MASK (54)
#endif /*RUPY*/
#define WIRELESS_ON  0
#define WIRELESS_OFF 1
#define CHG_SUSPEND_ON  1
#define CHG_SUSPEND_OFF 0
/* Quad Mod start */
//#define TEMP_TIMER (60 * HZ)
#define TEMP_TIMER (10 * HZ) /* 10sec */
/* Quad Mod end */
#define CHG_SUSPEND_WAIT_MSEC 21     /* 20ms */
/* Quad Mod start */
//#define BT_FULLTIME_WIRELESS 10      /* 10 minutes */
#define BT_FULLTIME_WIRELESS 3      /* 30 sec */
//#define TERM_CURR_WIRELESS   75      /* 75mA */
#define TERM_CURR_WIRELESS   60      /* 60mA */
/* Quad Mod end */
#if 1 /*RUPY*/
#define WIRELESS_CHARGE_FULL_ON  0
#define WIRELESS_CHARGE_FULL_OFF 1
#else
#define WIRELESS_CHARGE_FULL_ON  1
#define WIRELESS_CHARGE_FULL_OFF 0
#endif /*RUPY*/
#define WIRELESS_CHARGE_AUTO_LED_MASK 1
/* Jessie add end */
/* Quad add start */
#define WRLSS_SUSPEND_WAIT_MSEC      1       /* Less than 5ms */
#define WRLSS_CHG_STOP_WAIT_MSEC     6       /* More than 5ms */
#define WRLSS_STOP_NTFY_WAIT_MSEC        (21) /* more than 20ms */
#define PM8921_RECHG_MVOLT_AFTER_TO  4260    /* 4260mv */
#define WIRELESS_CHARGE_LEVEL_SHIFTER_DISABLE  0
#define WIRELESS_CHARGE_LEVEL_SHIFTER_ENABLE   1
#define WIRELESS_CHARGE_CURRENT_LIMIT_A  1
#define WIRELESS_CHARGE_CURRENT_LIMIT_B  0
#define PM_WIRELESS_LIMIT_DISABLE 0
#define PM_WIRELESS_LIMIT_ENABLE  1
#define PM_WIRELESS_LIMIT_A     2
#define PM_WIRELESS_LIMIT_B     1
#define PM_WIRELESS_LIMIT_NONE  0
/* Quad add end */
...
static struct fsm_state_to_batt_status map[] = {
	 ...
	 */
/* IDPower:npdc300033901	{FSM_STATE_ON_CHG_HIGHI_1, POWER_SUPPLY_STATUS_FULL}, */
	{FSM_STATE_ON_CHG_HIGHI_1, POWER_SUPPLY_STATUS_NOT_CHARGING}, /* IDPower:npdc300033901 */
	{FSM_STATE_ATC_2A, POWER_SUPPLY_STATUS_CHARGING},
	{FSM_STATE_ATC_2B, POWER_SUPPLY_STATUS_CHARGING},
//npdc300021072	{FSM_STATE_ON_BAT_3, POWER_SUPPLY_STATUS_DISCHARGING},
	{FSM_STATE_ON_BAT_3, POWER_SUPPLY_STATUS_NOT_CHARGING},  //npdc300021072
...
/* IDPower:npdc300033901	{FSM_STATE_EOC_10, POWER_SUPPLY_STATUS_FULL}, */
	{FSM_STATE_EOC_10, POWER_SUPPLY_STATUS_NOT_CHARGING}, /* IDPower:npdc300033901 */
...
struct pm8921_chg_chip {
	...
	int				thermal_levels;
#if defined(CONFIG_PM8921_BMS) /* IDPower:npdc300020757 */
	struct delayed_work		update_heartbeat_work;
#endif                         /* IDPower:npdc300020757 */
	struct delayed_work		eoc_work;
	struct delayed_work		unplug_check_work;
	struct delayed_work		vin_collapse_check_work;
/* Jessie add start */
	struct work_struct		wireless_work;
	struct delayed_work		wireless_timer_work;
	struct work_struct		chgfail_work;	/* Quad add */
/* Jessie add end */
...
/* IDPower:npdc300029475 start */
struct charge_property {
	int value;
	char const *val;
};

static struct charge_property charge_state_list[] = {
	{1, "enable"},
	{0, "disable"},
	{-1, NULL},
};

static struct charge_property limit_state_list[] = {
#if 0
	{1500,  "1500mA"  },
	{1300,  "1300mA"  },
	{1100,  "1100mA"  },
	...
	{0xC,  "1300mA"  },
	{0xA,  "1100mA"  },
	{0x8,  "950mA"   },	/* convert to 900mA, because 900mA limitation is required */
	{0x6,  "850mA"   },
	{0x4,  "750mA"   },
	{0x3,  "650mA"   },
	{0x2,  "500mA"   },
...
/* Quad add start */
static struct charge_property wireless_limit_state_list[] = {
	{PM_WIRELESS_LIMIT_A,     "limit_A" },
	{PM_WIRELESS_LIMIT_B,     "limit_B" },
	{PM_WIRELESS_LIMIT_NONE,  "no_limit"},
	{  -1,  NULL},
};
/* Quad add end */
...
#endif
/* IDPower:npdc300029475 end */

static int charging_disabled;
static int thermal_mitigation;
#ifndef CONFIG_PM8921_BMS
static int pm8921_battery_capacity = 100; /* IDPower:npdc300020757,npdc300029449 */
/*<npdc300030059>static int pm8921_old_soc = 99; *//*<npdc300021082>*/
static int pm8921_battery_soc;           /*<npdc300030059>*/
static int fgic_set_battery_soc_flg = 0; /*<npdc300030059>*/
#endif
/*
 * pm8921_limit_state_flg is used for charging current restrictions.
 *  0 : no restriction
 *  1 : restriction
 */
static int pm8921_limit_state_flg    = 0; /*<npdc300035206>*/
static int pm8921_limit_state_usb_ma = 0; /*<npdc300035206>*/
static DEFINE_MUTEX(vddmax_set_mutex); /*<npdc300035071>*/
static int get_prop_batt_temp(struct pm8921_chg_chip *chip); /* npdc300035887 */
static int configure_btm_flg = 0; /* npdc300035887 */
static int vbatdet_init_flg = 0; /* npdc300035887 */
#define PM8921_CHG_VDDMAX_MIN	3240 /* npdc300035887 */
static int temp_vddmax = PM8921_CHG_VDDMAX_MIN;       /* npdc300035887 */
static DEFINE_MUTEX(configure_btm_mutex); /* npdc300035887 */
int ocv_complete_flg = 0; /* npdc300035887 */

/* Jessie add start */
static int temp_ch_en = 1;
static int wireless_termcnt = 0;   /* termination count for wireless charge */
static struct wake_lock	wireless_lock;
/* Jessie add end */
...
static void pm8921_charger_eeprom_read( struct pm8921_chg_chip *chip );

//static unsigned long dpo_info_bat = 0;

#define DPO_STS_INIT    0
#define DPO_STS_ACT     1
//static unsigned char dpo_wait_sts = DPO_STS_INIT;
...
int pm8921_charger_enable(bool enable);                         /* IDPower:npdc300029475 */
/*<300035206>int pm8921_set_max_battery_charge_current(int ma);              *//* IDPower:npdc300034719 */
static void handle_start_ext_chg(struct pm8921_chg_chip *chip); /* IDPower:npdc300029475 */
static void handle_stop_ext_chg(struct pm8921_chg_chip *chip);  /* IDPower:npdc300029475 */
static int configure_btm(struct pm8921_chg_chip *chip); /*<npdc300034761>*/
static void __pm8921_charger_vbus_draw(unsigned int mA); /*<300035206>*/

/* sysfs */
static struct kobject *dpo_kobj;
static struct kobject *pm8921_charger_kobj; /* IDPower:npdc300029475 */

static ssize_t dpo_status_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf);
static ssize_t dpo_status_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count
);
static struct kobj_attribute dpo_attribute = __ATTR(dpo_st, 0644, dpo_status_show, dpo_status_store);
static ssize_t charge_state_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf);                          /* IDPower:npdc300029475 */
static ssize_t charge_state_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count);     /* IDPower:npdc300029475 */
static struct kobj_attribute charge_state_attribute = __ATTR(charge_state, 0666, charge_state_show, charge_state_store); /* IDPower:npdc300029475 */
static ssize_t limit_state_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf);                           /* IDPower:npdc300029475 */
static ssize_t limit_state_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count);      /* IDPower:npdc300029475 */
static struct kobj_attribute limit_state_attribute = __ATTR(limit_state, 0666, limit_state_show, limit_state_store);     /* IDPower:npdc300029475 */
/* Quad add start */
static ssize_t wireless_limit_state_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf);
static ssize_t wireless_limit_state_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count);
static struct kobj_attribute wireless_limit_state_attribute = __ATTR(wireless_limit_state, 0666, wireless_limit_state_show, wireless_limit_state_store);
static int wrlss_curr_limit_A = PM_WIRELESS_LIMIT_DISABLE;
static int wrlss_curr_limit_B = PM_WIRELESS_LIMIT_DISABLE;
static int wrlss_curr_limit_on_A(void);
static int wrlss_curr_limit_on_B(void);
static int wrlss_curr_limit_off(void);
static enum hrtimer_restart pulse_timeout(struct hrtimer *timer);
static enum hrtimer_restart charge_off_reason_timeout(struct hrtimer *timer);
DEFINE_MUTEX(wrlss_chg_mutex);
static DEFINE_MUTEX(wrlss_timer_work_mutex);
static DEFINE_MUTEX(wrlss_limit_mutex);
struct hrtimer		pulse_timer;
struct hrtimer		charge_off_reason_timer;
struct completion	pulse_completion;
struct completion	charge_off_reason_completion;
/* Quad add end */

static struct attribute *dpo_attrs[] =
{
        &dpo_attribute.attr,
        NULL
};
static struct attribute_group dpo_attr_group =
{
        .attrs = dpo_attrs,
};

/* IDPower:npdc300029475 start */
static struct attribute *pm8921_charger_attrs[] =
{
	&charge_state_attribute.attr,
	&limit_state_attribute.attr,
/* Quad add start */
	&wireless_limit_state_attribute.attr,
/* Quad add end */
	NULL
};
static struct attribute_group pm8921_charger_attr_group =
{
	.attrs = pm8921_charger_attrs,
};
/* IDPower:npdc300029475 end */

static ssize_t dpo_status_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
        unsigned long *base_info = NULL;
        unsigned long data = 0;

        base_info = (unsigned long *)ioremap(DMEM_DEV2_START, 0x1000);
        if(base_info != NULL)
        {
                data = *(base_info + DMEM_DUMMY_POW_STATUS_OFFSET);
                iounmap(base_info);
        }

        return sprintf(buf, "%ld", data);
}
...
static int __init msm_dpo_sysfs_init(void)
{
        dpo_kobj = kobject_create_and_add("dpo", NULL);
        if(!dpo_kobj)
        {
                return -ENOMEM;
        }

        return sysfs_create_group(dpo_kobj, &dpo_attr_group);
}
late_initcall(msm_dpo_sysfs_init);

/* IDPower:npdc300029475 start */
static int get_value(struct charge_property *list, const char *val, int initial)
{
	char buf[512];
	int cr;
	...
	while (list->val) {
		if (strncmp(list->val, buf, strlen(list->val)) == 0) {
			return list->value;
		}
		list++;
	}
...
static ssize_t charge_state_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
	return 0;
}

static ssize_t charge_state_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count)
{
	int charge_state = 0;
	...
	charge_state = get_value(charge_state_list, buf, charge_state);

	pr_info("charge_state=%d usb_target_ma=%d\n",charge_state,usb_target_ma);
	switch (charge_state) {
	case 1:
	case 0:
		break;
	...
	pm8921_charger_enable(charge_state);
	pm_chg_charge_dis( the_chip, !charge_state );
	/*<npdc300035206> start */
	if ((charge_state) &&
		(pm8921_limit_state_flg != 1) &&
		((usb_target_ma > 0) &&
		 (usb_target_ma < USB_WALL_THRESHOLD_MA))) {
		usb_target_ma = pm8921_limit_state_usb_ma;
...
/* Jessie add start */
	...
	{
		temp_ch_en = 1;
		pm8921_dev_dbg_it("%-40s : charge_state=%d \n", __func__, charge_state);
		pm8921_dev_dbg("%-40s : pass CHARGEON : safety_ic_charge_sts=%d \n", __func__, safety_ic_charge_sts);
		if( safety_ic_charge_sts == DSAFETY_CHG_NORMAL )
		{
/* Quad add start*/
			mutex_lock(&wrlss_chg_mutex);
/* Quad add end*/
			gpio_set_value( GPIO_CHG_SUSPEND, CHG_SUSPEND_OFF );
			pm8921_dev_dbg_it("%-40s : GPIO_CHG_SUSPEND : OFF \n", __func__);
/* Quad add start*/
...
/* Quad add start*/
		mutex_lock(&wrlss_chg_mutex);
/* Quad add end*/
		gpio_set_value( GPIO_WIRELESS_CHARGE_UART, WIRELESS_CHARGE_FULL_OFF );
		pm8921_dev_dbg("%-40s : GPIO_WIRELESS_CHARGE_UART : OFF \n",__func__);
		gpio_set_value( GPIO_CHG_SUSPEND, CHG_SUSPEND_ON );
		pm8921_dev_dbg_it("%-40s : GPIO_CHG_SUSPEND : ON \n", __func__);
...
/* Jessie add end */
	...
	power_supply_changed(&the_chip->usb_psy); /*<npdc300035206>*/
	power_supply_changed(&the_chip->dc_psy);  /*<npdc300035206>*/
	
	return count;
}

static ssize_t limit_state_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
{
	return 0;
}

static ssize_t limit_state_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count)
{
	int limit_state = 0;
#if 0 /*<300035206>*/
	int usb_ma      = 900;
...
/* Quad add end */
	...
	pr_info("[chg] limit_str %s\n", buf);
#if 1 /*<npdc300035206>*/
	if (pm8921_limit_state_usb_ma > USB_WALL_THRESHOLD_MA) {
		limit_state = get_value(limit_state_list, buf, limit_state);

		if ( limit_state <= 0 ) {
			usb_target_ma = pm8921_limit_state_usb_ma;
			pm8921_limit_state_flg = 0;
		}
		else {
/* Quad mod start */
/*			usb_target_ma = usb_ma_table[limit_state].usb_ma;*/
			for (i = ARRAY_SIZE(usb_ma_table) - 1; i >= 0; i--) {
				if (usb_ma_table[i].value == limit_state) {
					usb_target_ma = usb_ma_table[i].usb_ma;
					break;
				}
			}
/* Quad mod end */
	...
	if ( limit_state == 0 )
	{
		...
		for (i = ARRAY_SIZE(usb_ma_table) - 1; i >= 0; i--) {
			if (usb_ma_table[i].usb_ma == usb_ma) {
				limit_state = i;
				break;
			}
		}
		pr_info("[chg] usb_ma %d\n", usb_ma );
	}
	pr_info("[chg] limit %d\n", limit_state );
	pm8921_set_max_battery_charge_current(usb_ma_table[limit_state].usb_ma); /* IDPower:npdc300034719 */
	pm_chg_iusbmax_set(the_chip,limit_state);
#endif /*<npdc300035206>*/
...
static ssize_t wireless_limit_state_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count)
{
	int wireless_limit_state = 0;
	int wireless_charge = WIRELESS_OFF;
	
	pm8921_dev_dbg_it("%-40s : start \n", __func__);

	wireless_charge = gpio_get_value(GPIO_CHG_STS);
	
	pm8921_dev_dbg("%-40s : wrlss_curr_limit_A=%d\n",__func__, wrlss_curr_limit_A);
	pm8921_dev_dbg("%-40s : wrlss_curr_limit_B=%d\n",__func__, wrlss_curr_limit_B);

	wireless_limit_state = get_value(wireless_limit_state_list, buf, wireless_limit_state);
	
	switch( wireless_limit_state ) {
	case PM_WIRELESS_LIMIT_A:
		pm8921_dev_dbg("%-40s : wireless_limit_state=%d\n",__func__, wireless_limit_state);
		mutex_lock(&wrlss_limit_mutex);
		if ( wireless_charge == WIRELESS_ON ) {
			pm8921_dev_dbg("%-40s : Wireless Charge ON \n",__func__);
			if( wrlss_curr_limit_A == PM_WIRELESS_LIMIT_DISABLE ) {
				pm8921_dev_dbg("%-40s : current limit A Disable \n",__func__);
/* Quad mod start <npdc300060721> */
				if(wrlss_curr_limit_B == PM_WIRELESS_LIMIT_ENABLE){
					gpio_set_value( GPIO_WIRELESS_CHARGE_CURRENT_LIMIT, WIRELESS_CHARGE_CURRENT_LIMIT_A );
					pm8921_dev_dbg_it("%-40s : current limit B -> A \n",__func__);
				}
				else{
					wrlss_curr_limit_on_A();
					pm8921_dev_dbg_it("%-40s : current limit A Enable \n",__func__);
				}
/* Quad mod end <npdc300060721> */
			}
		}
		wrlss_curr_limit_A = PM_WIRELESS_LIMIT_ENABLE;
		wrlss_curr_limit_B = PM_WIRELESS_LIMIT_DISABLE;	/* Quad add <npdc300060721> */
		mutex_unlock(&wrlss_limit_mutex);
		break;
		
	case PM_WIRELESS_LIMIT_B:
/* Quad add start <npdc300060721> */
		pm8921_dev_dbg("%-40s : wireless_limit_state=%d\n",__func__, wireless_limit_state);
		mutex_lock(&wrlss_limit_mutex);
		if ( wireless_charge == WIRELESS_ON ) {
			pm8921_dev_dbg("%-40s : Wireless Charge ON \n",__func__);
			if( wrlss_curr_limit_B == PM_WIRELESS_LIMIT_DISABLE ) {
				pm8921_dev_dbg("%-40s : current limit B Disable \n",__func__);
				if( wrlss_curr_limit_A == PM_WIRELESS_LIMIT_ENABLE ) {
					gpio_set_value( GPIO_WIRELESS_CHARGE_CURRENT_LIMIT, WIRELESS_CHARGE_CURRENT_LIMIT_B );
					pm8921_dev_dbg_it("%-40s : current limit A -> B \n",__func__);
				}
				else{
					wrlss_curr_limit_on_B();
					pm8921_dev_dbg_it("%-40s : current limit B Enable \n",__func__);
				}
			}
		}
		wrlss_curr_limit_A = PM_WIRELESS_LIMIT_DISABLE;
		wrlss_curr_limit_B = PM_WIRELESS_LIMIT_ENABLE;
		mutex_unlock(&wrlss_limit_mutex);
/* Quad add end <npdc300060721> */
		break;
		
	case PM_WIRELESS_LIMIT_NONE:
		pm8921_dev_dbg("%-40s : wireless_limit_state=%d\n",__func__, wireless_limit_state);
		mutex_lock(&wrlss_limit_mutex);
		if ( wireless_charge == WIRELESS_ON ) {
			pm8921_dev_dbg("%-40s : Wireless Charge ON \n",__func__);
/* Quad mod start <npdc300060721> */
			if((wrlss_curr_limit_A == PM_WIRELESS_LIMIT_ENABLE) ||
			   (wrlss_curr_limit_B == PM_WIRELESS_LIMIT_ENABLE)   ){
				pm8921_dev_dbg("%-40s : current limit A or B Enable \n",__func__);
				wrlss_curr_limit_off();
				pm8921_dev_dbg_it("%-40s : current limit A and B Disable \n",__func__);
			}
/* Quad mod end <npdc300060721> */
		}
		wrlss_curr_limit_A = PM_WIRELESS_LIMIT_DISABLE;
	...
	pm8921_dev_dbg_it("%-40s : wrlss_curr_limit_A=%d\n",__func__, wrlss_curr_limit_A);
	pm8921_dev_dbg_it("%-40s : wrlss_curr_limit_B=%d\n",__func__, wrlss_curr_limit_B);
	pm8921_dev_dbg("%-40s : end\n", __func__);
...
static int wrlss_curr_limit_on_A(void)
{
	...
	INIT_COMPLETION(pulse_completion);
	
	gpio_set_value( GPIO_WIRELESS_CHARGE_UART, WIRELESS_CHARGE_FULL_OFF );
	gpio_set_value( GPIO_WIRELESS_CHARGE_CURRENT_LIMIT, WIRELESS_CHARGE_CURRENT_LIMIT_A );
	gpio_set_value( GPIO_CHG_SUSPEND, CHG_SUSPEND_ON );
	
	hrtimer_start(&pulse_timer, ktime_set(0, (WRLSS_SUSPEND_WAIT_MSEC * 1000 * 1000)) ,HRTIMER_MODE_REL);
	wait_for_completion(&pulse_completion);
	/* gpio_set_value( GPIO_CHG_SUSPEND, CHG_SUSPEND_OFF ); is done by pulse_timeout */
...
static int wrlss_curr_limit_off(void)
{
	...
	hrtimer_cancel(&pulse_timer);
	INIT_COMPLETION(pulse_completion);
	hrtimer_cancel(&charge_off_reason_timer);
	INIT_COMPLETION(charge_off_reason_completion);
	
	gpio_set_value( GPIO_WIRELESS_CHARGE_CURRENT_LIMIT, WIRELESS_CHARGE_CURRENT_LIMIT_B );
	gpio_set_value( GPIO_WIRELESS_CHARGE_UART, WIRELESS_CHARGE_FULL_ON );
	gpio_set_value( GPIO_CHG_SUSPEND, CHG_SUSPEND_ON );
	
	hrtimer_start(&pulse_timer, ktime_set(0, (WRLSS_SUSPEND_WAIT_MSEC * 1000 * 1000)) ,HRTIMER_MODE_REL);
	hrtimer_start(&charge_off_reason_timer, ktime_set(0, (WRLSS_STOP_NTFY_WAIT_MSEC * 1000 * 1000)) ,HRTIMER_MODE_REL);
	wait_for_completion(&pulse_completion);
	/* gpio_set_value( GPIO_CHG_SUSPEND, CHG_SUSPEND_OFF ); is done by pulse_timeout */
	
	wait_for_completion(&charge_off_reason_completion);
	/* gpio_set_value( GPIO_WIRELESS_CHARGE_UART, WIRELESS_CHARGE_FULL_OFF ); is done by charge_off_reason_timeout */
...
enum hrtimer_restart pulse_timeout(struct hrtimer *timer)
{
    gpio_set_value( GPIO_CHG_SUSPEND, CHG_SUSPEND_OFF );
    complete(&pulse_completion);
    return HRTIMER_NORESTART;
}

enum hrtimer_restart charge_off_reason_timeout(struct hrtimer *timer)
{
	gpio_set_value( GPIO_WIRELESS_CHARGE_UART, WIRELESS_CHARGE_FULL_OFF );
    complete(&charge_off_reason_completion);
    return HRTIMER_NORESTART;
}
/* Quad add end */

static int __init pm8921_charger_sysfs_init(void)
{
        pm8921_charger_kobj = kobject_create_and_add("pm8921_charger", NULL);
        if(!pm8921_charger_kobj)
        {
                return -ENOMEM;
        }

        return sysfs_create_group(pm8921_charger_kobj, &pm8921_charger_attr_group);
}
late_initcall(pm8921_charger_sysfs_init);
/* IDPower:npdc300029475 end */
...
{
//	int rc;
	int rc = 0; /*<npdc300035206>*/
	unsigned int temp_vdet_mv;
	int temp = 0; /* npdc300035887 */

	if( enable )
	{
		if ( pm8921_chg_is_enabled( chip, VBATDET_LOW_IRQ ))
		{
			disable_irq_wake( chip->pmic_chg_irq[ VBATDET_LOW_IRQ ]);
			pm8921_chg_disable_irq( chip, VBATDET_LOW_IRQ );
		}

		/* VBATDET set to VBATDET value */
		if( chip->is_bat_cool )
		{
			/* cool condition */
			temp_vdet_mv = chip->cool_bat_voltage;
		}
		else if( chip->is_bat_warm )
		{
			/* warm condition */
			temp_vdet_mv = chip->warm_bat_voltage;
		}
		else
		{
			/* npdc300035887 start */
			if( vbatdet_init_flg == 1 )
			{
				temp = get_prop_batt_temp(chip);
				if( temp >= chip->warm_temp_dc )
				{
					temp_vdet_mv = chip->warm_bat_voltage;
				}
				else if( temp <= chip->cool_temp_dc )
				{
					temp_vdet_mv = chip->cool_bat_voltage;
				}
				else
				{
					temp_vdet_mv = chip->max_voltage_mv;
				}
			}
			else
			{
		...
		pr_debug("enable set vbatdet comprator voltage to %d\n", temp_vdet_mv );
		rc = pm_chg_vbatdet_set(chip, temp_vdet_mv );
		if( rc )
		{
			pr_err("Failed to set vbatdet comprator voltage to %d rc=%d\n", chip->max_voltage_mv, rc );
		}
		vbatdet_init_flg = 0; /* npdc300035887 */
		/*<npdc300035206> start */
		rc = pm_chg_masked_write(chip, CHG_CNTRL_3, CHG_EN_BIT, CHG_EN_BIT);
		if( rc )
		{
			pr_err("Failed to set CHG_CNTRL_3 CHG_EN_BIT=1 rc=%d\n", rc );
		}
		/*<npdc300035206> end   */
	}
	else
	{
		/*<npdc300035206> start */
		rc = pm_chg_masked_write(chip, CHG_CNTRL_3, CHG_EN_BIT, 0);
		if( rc )
		{
			pr_err("Failed to set CHG_CNTRL_3 CHG_EN_BIT=0 rc=%d\n", rc );
		}
		/*<npdc300035206> end   */
		...
		{
			/* cool condition */
			temp_vdet_mv = chip->cool_bat_voltage - chip->resume_voltage_delta;
		}
		else if( chip->is_bat_warm )
		{
			/* warm condition */
			temp_vdet_mv = chip->max_voltage_mv - chip->resume_voltage_delta;
		}
		else
		{
			/* npdc300035887 start */
		...
		pr_debug("disable set vbatdet comprator voltage to %d\n", temp_vdet_mv );
		rc = pm_chg_vbatdet_set(chip, temp_vdet_mv );
		if( rc )
		{
			pr_err("Failed to set vbatdet comprator voltage to %d rc=%d\n", temp_vdet_mv - chip->resume_voltage_delta, rc );
		}
		if( !pm8921_chg_is_enabled( chip, VBATDET_LOW_IRQ ))
		{
...
//npdc300035887 #define PM8921_CHG_VDDMAX_MIN	3240 /* npdc300035347 */
...
static int pm_chg_vddmax_set(struct pm8921_chg_chip *chip, int voltage)
{
	...
	mutex_lock(&vddmax_set_mutex); /* <npdc300035071> */

	ret = pm_chg_vddmax_get(chip, &current_mv);
	if (ret) {
		mutex_unlock(&vddmax_set_mutex); /* <npdc300035071> */
...
//<npdc300035071>	if (is_usb_chg_plugged_in(chip)) {
		if (current_mv < voltage) {
		...
		for (i = 0; i < steps; i++) {
#if 1 /* IDPower npdc300035071 */
			if (increase){
				/* Wait 10msec */
				msleep( 10 );
				current_mv += PM8921_CHG_V_STEP_MV;
				temp_vddmax = current_mv; /* npdc300035887 */
				ret |= __pm_chg_vddmax_set(chip, current_mv);
				if(pm_chg_get_fsm_state(the_chip) == FSM_STATE_ON_BAT_3){
					mutex_unlock(&vddmax_set_mutex); /* <npdc300035071> */
					return ret;
				}
			}
...
//<npdc300035071>	}
	...
	temp_vddmax = voltage; /* npdc300035887 */
...
#if defined(CONFIG_PM8921_BMS) /* IDPower:npdc300029475 */
struct usb_ma_limit_entry {
	int	usb_ma;
	u8	value;
};
...
static void bms_notify(struct work_struct *work)
{
	...
	int temp = 0;  /* npdc300035887 */
#ifndef CONFIG_PM8921_BMS      /* IDPower */
	int ret = 0;               /*<npdc300034761>*/
	unsigned char data;        /* IDPower */
	data = DCTL_CHG_NO_CHARGE; /* IDPower */
#endif                         /* IDPower */

	if (n->is_charging) {
#if defined(CONFIG_PM8921_BMS) /* IDPower */
		pm8921_bms_charging_began();
#else /* IDPower */
		/*<npdc300035071> start */
		if(pm_chg_get_fsm_state(the_chip) == FSM_STATE_FAST_CHG_7){
				/* npdc300035887 start */
				if(the_chip->is_bat_warm){
					...
					if( temp >= the_chip->warm_temp_dc){
						pm_chg_vddmax_set(the_chip, the_chip->warm_bat_voltage);
					}
					else if(temp <= the_chip->cool_temp_dc){
						pm_chg_vddmax_set(the_chip, the_chip->cool_bat_voltage);
					}
					else{
		...
		if (!(the_chip->cool_temp_dc == INT_MIN && the_chip->warm_temp_dc == INT_MIN)) {
			ret = configure_btm(the_chip);
			if (ret) {
				pr_err("couldn't register with btm ret=%d\n", ret);
			}
		}
		/*<npdc300034761> end   */
		data = DCTL_CHG_CHARGE;
		pfgc_fgc_mstate(D_FGC_CHG_INT_IND, &data);
#endif /* IDPower */
	} else {
#if defined(CONFIG_PM8921_BMS) /* IDPower */
		...
		/*<npdc300035071> start */
		if(pm_chg_get_fsm_state(the_chip) == FSM_STATE_ON_BAT_3){
				pm_chg_vddmax_set(the_chip, PM8921_CHG_VDDMAX_MIN);
		}
		/*<npdc300035071> end */
		data = DCTL_CHG_NO_CHARGE;
		pfgc_fgc_mstate(D_FGC_CHG_INT_IND, &data);
		/*<npdc300034761> start */
		if (!(the_chip->cool_temp_dc == INT_MIN && the_chip->warm_temp_dc == INT_MIN)) {
			if( ocv_complete_flg != 0 )
			{
				mutex_lock(&configure_btm_mutex); /* npdc300035887 */
				configure_btm_flg = 0;
				ret = pm8xxx_adc_btm_end();
				if (ret)
					pr_err("Failed to disable BTM on suspend rc=%d\n", ret);
				mutex_unlock(&configure_btm_mutex); /* npdc300035887 */
			}
		}
		/*<npdc300034761> end   */
#endif /* IDPower */
...
/*<npdc300035206>#define USB_WALL_THRESHOLD_MA	500 */
...
// Jessie add start
		{
			pm8921_dev_dbg("%-40s : charging_disabled=%d \n", __func__, charging_disabled);
			// 既存の処理で charging_disabled = 1 は上位から充電禁止にされている
			// 状態だと思われる。この状態でも無接点充電は行われると思われるので
			// 無接点充電中であれば 1 を返す。
			if(wireless_charge == WIRELESS_ON){
				val->intval = 1;
				pm8921_dev_dbg("%-40s : val->intval=%d  wireless_charge=%d \n", __func__, val->intval, wireless_charge);
			}
// Jessie add end
			return 0;
// Jessie add start
...
// Jessie add end
		...
		if (is_ext_charging(the_chip)) {
			val->intval = 1;
// Jessie add start
			pm8921_dev_dbg("%-40s : val->intval=%d \n", __func__, val->intval);
// Jessie add end
			return 0;
		}
		...
		if (pm_is_chg_charge_dis(the_chip)) {
			val->intval = 0;
// Jessie add start
			pm8921_dev_dbg("%-40s : pm_is_chg_charge_dis()=TRUE \n", __func__);
			if(wireless_charge == WIRELESS_ON){
				val->intval = 1;
				pm8921_dev_dbg("%-40s : val->intval=%d  wireless_charge=%d \n", __func__, val->intval, wireless_charge);
			}
...
/*<npdc300035206>		if (usb_target_ma > USB_WALL_THRESHOLD_MA) */
		if (usb_target_ma != 0) /*<npdc300035206>*/
			val->intval = is_usb_chg_plugged_in(the_chip);
		/* <npdc300035627> start */
		if (val->intval == 0) {
			if (((pm_chg_get_rt_status(the_chip, USBIN_OV_IRQ) != 0) ||
			     (pm_chg_get_rt_status(the_chip, USBIN_UV_IRQ) != 0)) &&
			    (pm8921_limit_state_usb_ma > USB_WALL_THRESHOLD_MA)) {
				val->intval = 1;
// Jessie add start	
			}else{
				pm8921_dev_dbg("%-40s : val->intval=%d \n", __func__, val->intval);
...
// Jessie add end
	...
	/* npdc300035887 start */
	if( temp_vddmax == PM8921_CHG_VDDMAX_MIN )
	{
		if((pm_chg_get_fsm_state(the_chip) == FSM_STATE_FAST_CHG_7) ||
		   (pm_chg_get_fsm_state(the_chip) == FSM_STATE_TRKL_CHG_8))
		{
			temp = get_prop_batt_temp(the_chip);
			if( temp >= the_chip->warm_temp_dc )
			{
...
// Jessie del end
// Jessie add start
//		if(val->intval == 0){		// Quad mod start
		else{						// Quad mod end
			pm8921_dev_dbg("%-40s : val->intval=%d \n", __func__, val->intval);
			if(wireless_charge == WIRELESS_ON){
				val->intval = 1;
...
#else /* IDPower */
	int percent_soc;
	pfgc_fgc_mstate(D_FGC_CAPACITY_REQ, &percent_soc);
#endif /* IDPower */
...
#else /* IDPower */
	for (retry = 0; retry < 3; retry++){						/* npdc300035452 */
		rc = pfgc_fgc_mstate(D_FGC_CURRENT_REQ, &result_ua);	/* npdc300035452 */
		if (rc == 0){											/* npdc300035452 */
			break;												/* npdc300035452 */
		}														/* npdc300035452 */
		msleep(50);												/* npdc300035452 */
	}															/* npdc300035452 */
#endif /* IDPower */
...
#else /* IDPower */
	for (retry = 0; retry < 3; retry++){						/* npdc300035452 */
		pfgc_fgc_mstate(D_FGC_FCC_REQ, &rc);
		if (rc >= 0){											/* npdc300035452 */
			break;												/* npdc300035452 */
		}														/* npdc300035452 */
		msleep(50);												/* npdc300035452 */
...
static int get_prop_batt_health(struct pm8921_chg_chip *chip)
{
	...
	if (temp)
		return POWER_SUPPLY_HEALTH_OVERHEAT; /*<npdc300035275>*/
				       ...
				       union power_supply_propval *val)
{
	struct pm8921_chg_chip *chip = container_of(psy, struct pm8921_chg_chip,
								batt_psy);
// Jessie add start
	int wireless_charge = gpio_get_value(GPIO_CHG_STS);
// Jessie add end
...
// Jessie add start
		pm8921_dev_dbg("%-40s : pass POWER_SUPPLY_PROP_STATUS : val->intval=%d \n", __func__, val->intval);
...
// Jessie add start
		pm8921_dev_dbg("%-40s : pass POWER_SUPPLY_PROP_CHARGE_TYPE : val->intval=%d \n", __func__, val->intval);
...
// #Jessie_dbg start
		pm8921_dev_dbg("%-40s : pass POWER_SUPPLY_PROP_HEALTH : val->intval=%d \n", __func__, val->intval);
...
#if defined(CONFIG_PM8921_BMS) /* IDPower:npdc300020757,npdc300029449 */
		val->intval = get_prop_batt_capacity(chip);
#else  /* IDPower:npdc300020757,npdc300029449 */
		if (fgic_set_battery_soc_flg == 1) {
			val->intval = pm8921_battery_capacity;
		}
		else {
			val->intval = get_prop_batt_capacity(chip);
		}
...
void pm8921_charger_vbus_draw(unsigned int mA)
{
	...
	pr_info("Enter charge=%d target_ma=%d\n", mA, usb_target_ma);
	...
	pm8921_limit_state_usb_ma = mA; /*<npdc300035206>*/
...
/* IDPower:npdc300020757,npdc300029449 start */
#if defined(CONFIG_PM8921_BMS)
/*<npdc300021082> int pm8921_set_battery_capacity(int capacity) */
int pm8921_set_battery_capacity(int soc, int capacity) /*<npdc300021082>*/
{
	return 0;
}
#else
...
int pm8921_set_battery_capacity(int soc, int capacity) /*<npdc300021082>*/
{
	int fsm_state; /*<npdc300021082>*/
// Jessie add start
	int wireless_charge = WIRELESS_OFF;
// Jessie add end

	pm8921_battery_capacity = capacity;
	pm8921_battery_soc      = soc;       /*<npdc300030059>*/
	if (fgic_set_battery_soc_flg == 0) { /*<npdc300030059>*/
		fgic_set_battery_soc_flg = 1;    /*<npdc300030059>*/
	}                                    /*<npdc300030059>*/
...
// Jessie add start
		wireless_charge = gpio_get_value(GPIO_CHG_STS);
		pm8921_dev_dbg_it("%-40s : soc=%d  capacity=%d\n",__func__, soc, capacity);
		pm8921_dev_dbg("%-40s : wireless_charge=0x%x\n",__func__, wireless_charge);
// Jessie add end
		
		/*<npdc300021082> start */
		fsm_state = pm_chg_get_fsm_state(the_chip);
/*<npdc300030059>		if ((soc == 100) && (pm8921_old_soc < 100) && (is_battery_charging(fsm_state))) { */
		if ((soc == 100) && (is_battery_charging(fsm_state))) { /*<npdc300030059>*/
/*<npdc300034936>			if (!wake_lock_active(&the_chip->eoc_wake_lock)) {  *//*<npdc300030059>*/
				wake_lock(&the_chip->eoc_wake_lock);
				if (!delayed_work_pending(&the_chip->eoc_work)) {
					pr_info("[chg] eoc_work start\n");
/*<npdc300034936>					schedule_delayed_work(&the_chip->eoc_work, */
/*<npdc300034936>								round_jiffies_relative(msecs_to_jiffies */
/*<npdc300034936>									(EOC_CHECK_PERIOD_MS))); */
					schedule_delayed_work(&the_chip->eoc_work, 0); /*<npdc300034936>*/
				}
/*<npdc300034936>			}                                                   *//*<npdc300030059>*/
		}
/*<npdc300030059>		pm8921_old_soc = soc; */
		/*<npdc300021082> end   */
// Jessie add start
		else if ((soc == 100) && (!is_battery_charging(fsm_state)) && (wireless_charge == WIRELESS_ON)) {
			pm8921_dev_dbg("%-40s : capacity100(wireless) \n",__func__);
			if (!(wake_lock_active(&wireless_lock))) {
				wake_lock(&wireless_lock);
				pm8921_dev_dbg("%-40s : wake_lock(wireless_lock) \n",__func__);
			}
/* Quad add start */
			mutex_lock(&wrlss_timer_work_mutex);
			if(!delayed_work_pending(&the_chip->wireless_timer_work)) {
				queue_delayed_work(g_pm8921_wq, &the_chip->wireless_timer_work, 0);
				pm8921_dev_dbg("%-40s : Wireless Charging timer start \n",__func__);
			}
			mutex_unlock(&wrlss_timer_work_mutex);
/* Quad add end */
		}
		else{
			;
...
#endif
EXPORT_SYMBOL(pm8921_set_battery_capacity);
/* IDPower:npdc300020757,npdc300029449 end   */
...
/* IDPower npdc300020773 start */
int pm8921_get_regulator_state(enum which_resource resource, int *enable, int *lpm)
{
	u16 addr[2] = {0xB8, 0xC0};
	u8 val = 0;
	int err;
	...
	err = pm8xxx_readb(the_chip->dev->parent, addr[resource], &val);
	if(err)
	{
		pr_err("pm8xxx_readb fail: addr=%03X, rc=%d\n", addr[resource], err);
		return err;
...
EXPORT_SYMBOL(pm8921_get_regulator_state);
/* IDPower npdc300020773 end */

/* IDPower npdc300020773 start */
int pm8921_get_registor_state(u16 addr, u8 *val)
{
	int err;
	...
	err = pm8xxx_readb(the_chip->dev->parent, addr, val);
	if(err)
	{
		pr_err("pm8xxx_readb fail: addr=%03X, rc=%d\n", addr, err);
		return err;
...
EXPORT_SYMBOL(pm8921_get_registor_state);
/* IDPower npdc300020773 end */

/* IDPower npdc300035052 start */
int pm8921_set_registor_state(u16 addr, u8 mask, u8 val)
{
	int err;
	...
	err = pm_chg_masked_write(the_chip, addr, mask, val);
	if(err)
	{
		pr_err("pm_chg_masked_write fail: addr=%03X, rc=%d\n", addr, err);
		return err;
	}
	
	return 0;
}
EXPORT_SYMBOL(pm8921_set_registor_state);
/* IDPower npdc300035052 end */
...
/* Quad add start */
EXPORT_SYMBOL(pm8921_batt_temperature); /* <Quad> *//* PTC */
/* Quad add end */
...
static void handle_start_ext_chg(struct pm8921_chg_chip *chip)
{
	...
	int batt_temp_ok;
	int vbat_ov;
/*<npdc300034936>	unsigned long delay = */
/*<npdc300034936>		round_jiffies_relative(msecs_to_jiffies(EOC_CHECK_PERIOD_MS)); */
	...
	bms_notify_check(chip);
	/* Start BMS */
#if defined(CONFIG_PM8921_BMS) /* IDPower:npdc300021082 */
	schedule_delayed_work(&chip->eoc_work, delay);
	wake_lock(&chip->eoc_wake_lock);
#else                          /* IDPower:npdc300021082 */
/*<npdc300021082>	wake_lock(&chip->eoc_wake_lock); */
	/*<npdc300030059> start */
/*<npdc300034936>	if (!wake_lock_active(&the_chip->eoc_wake_lock)) { */
		wake_lock(&chip->eoc_wake_lock);
		pr_info("[chg] eoc_work start\n");
/*<npdc300034936>		schedule_delayed_work(&chip->eoc_work, delay); */
		schedule_delayed_work(&chip->eoc_work, 0); /*<npdc300034936>*/
/*<npdc300034936>	} */
	/*<npdc300030059> end   */
#endif                         /* IDPower:npdc300021082 */
	/* Update battery charging LEDs and user space battery info */
	power_supply_changed(&chip->batt_psy);
}
...
/* npdc300036015 start */
static void ov_configure_vddmax_work(struct work_struct *work)
{
	...
	__pm_chg_vddmax_set(the_chip, PM8921_CHG_V_MIN_MV); /* npdc300036418 */

	if( is_charging )
	{
		if(the_chip->is_bat_cool)
		{
			pm_chg_vddmax_set(the_chip, the_chip->cool_bat_voltage);
		}
		else if(the_chip->is_bat_warm)
		{
			pm_chg_vddmax_set(the_chip, the_chip->warm_bat_voltage);
		}
		else
	...
	enable_irq_wake(the_chip->pmic_chg_irq[USBIN_OV_IRQ]); /* npdc300036418 */
	pm8921_chg_enable_irq(the_chip, USBIN_OV_IRQ);         /* npdc300036418 */
}
DECLARE_WORK(ov_config_vddmax_work, ov_configure_vddmax_work);
/* npdc300036015 end */

static irqreturn_t usbin_ov_irq_handler(int irq, void *data)
{
//npdc300036418	pr_err("USB OverVoltage\n");
//npdc300036418	__pm_chg_vddmax_set(the_chip, PM8921_CHG_V_MIN_MV); /* npdc300036015 */
	pm8921_chg_disable_irq(the_chip, USBIN_OV_IRQ);     /* npdc300036418 */
	schedule_work(&ov_config_vddmax_work);              /* npdc300036015 */
	return IRQ_HANDLED;
}
...
{
/* Quad del	struct pm8921_chg_chip *chip = data;*/
//IDPower npdc300034064	int ret;

#if 0 /* IDPower npdc300034064 */
	ret = pm_chg_failed_clear(chip, 1);
	if (ret)
		pr_err("Failed to write CHG_FAILED_CLEAR bit\n");
#endif
#if 0	/* Quad del start */
	handle_stop_ext_chg(chip); /* IDPower npdc300034064 */
	...
	queue_work(g_pm8921_wq, &the_chip->chgfail_work);	/* Quad add */
	return IRQ_HANDLED;
}

/* Quad add start */
static void pm8921_chgfail_work_func(struct work_struct *work)
{
	int ret;
	int rc;
	unsigned int current_voltage_mv = 0;
	
	pm8921_dev_dbg_it("%-40s : start \n", __func__);
	
	current_voltage_mv = get_prop_battery_uvolts(the_chip) / 1000;
	
	if(current_voltage_mv < PM8921_RECHG_MVOLT_AFTER_TO) {
		pm8921_dev_dbg_it("%-40s : Restart charge. current_voltage_mv = %d\n",__func__, current_voltage_mv);
		ret = pm_chg_failed_clear(the_chip, 1);
		if (ret){
			pr_err("Failed to write CHG_FAILED_CLEAR bit\n");
		}
		rc = pm_chg_tchg_max_set(the_chip, the_chip->safety_time);
		if (rc) {
			pr_err("Failed to set max time to %d minutes rc=%d\n",
							the_chip->safety_time, rc);
		}
	}
	else {
		pm8921_dev_dbg_it("%-40s : Stop charge. current_voltage_mv = %d\n",__func__, current_voltage_mv);
...
#ifndef CONFIG_PM8921_BMS	/* Quad add <npdc300052485> */
	ibat = ~ibat;			/* Quad add <npdc300052485> */
#endif						/* Quad add <npdc300052485> */
	if (reg_loop & VIN_ACTIVE_BIT) {
...
/*<npdc300034936>		if (!wake_lock_active(&the_chip->eoc_wake_lock)) { */
			wake_lock(&chip->eoc_wake_lock);
			pr_info("[chg] eoc_work start\n");
/*<npdc300034936>			schedule_delayed_work(&chip->eoc_work, */
/*<npdc300034936>						round_jiffies_relative(msecs_to_jiffies */
/*<npdc300034936>							(EOC_CHECK_PERIOD_MS))); */
			schedule_delayed_work(&chip->eoc_work, 0); /*<npdc300034936>*/
/*<npdc300034936>		} */
...
{
	int err = 0;
	signed char cool_temp_delta = 0;
	signed char warm_temp_delta = 0;
	struct pm8921_chg_chip *chip_tmp;
        unsigned long *base_info = NULL;

	chip_tmp = kzalloc( sizeof( struct pm8921_chg_chip ), GFP_KERNEL );
   ...
   if( base_info == NULL )
    {
		pr_err("Cannot ioremap base_info\n");
		kfree( chip_tmp );
		return;
    }

	chip_tmp->safety_time = *( base_info + DMEM_CHG_TOTAL_TIMER_OFFSET );
	chip_tmp->max_voltage_mv = *( base_info + DMEM_CHG_MAX_VOLTAGE_ADJUST_OFFSET );
	chip_tmp->resume_voltage_delta = *( base_info + DMEM_CHG_RESUME_VOLTAGE_OFFSET );
	chip_tmp->term_current = *( base_info + DMEM_CHG_TERM_CURRENT_OFFSET );
	chip_tmp->cool_temp_dc = *( base_info + DMEM_CHG_COOL_TEMP_ADJUST_OFFSET );
	chip_tmp->warm_temp_dc = *( base_info + DMEM_CHG_WARM_TEMP_ADJUST_OFFSET );
	chip_tmp->temp_check_period = *( base_info + DMEM_CHG_TEMP_CHECK_PERIOD_OFFSET );
	chip_tmp->max_bat_chg_current = *( base_info + DMEM_CHG_MAX_BAT_CHG_CURRENT_OFFSET );
	chip_tmp->cool_bat_chg_current = *( base_info + DMEM_CHG_COOL_BAT_CHG_CURRENT_OFFSET );
	chip_tmp->warm_bat_chg_current = *( base_info + DMEM_CHG_WARM_BAT_CHG_CURRENT_OFFSET );
	chip_tmp->cool_bat_voltage = *( base_info + DMEM_CHG_COOL_BAT_CHG_VOLTAGE_OFFSET );
	chip_tmp->warm_bat_voltage = *( base_info + DMEM_CHG_WARM_BAT_CHG_VOLTAGE_OFFSET );
	cool_temp_delta = *( base_info + DMEM_CHG_COOL_TEMP_DELTA_OFFSET );
	warm_temp_delta = *( base_info + DMEM_CHG_WARM_TEMP_DELTA_OFFSET );
	err = *( base_info + DMEM_CHG_READ_ERR_OFFSET );

	if(cool_temp_delta < 0){
		chip_tmp->cool_temp_dc = chip_tmp->cool_temp_dc + ( signed int )(0xFFFFFF00 | cool_temp_delta);
	}
	else{
		chip_tmp->cool_temp_dc = chip_tmp->cool_temp_dc + ( signed int )(0xFF & cool_temp_delta);
	}
	if(warm_temp_delta < 0){
		chip_tmp->warm_temp_dc = chip_tmp->warm_temp_dc + ( signed int )(0xFFFFFF00 | warm_temp_delta);
	}
	else{
		chip_tmp->warm_temp_dc = chip_tmp->warm_temp_dc + ( signed int )(0xFF & warm_temp_delta);
	}

	if( err == 0 )
	{
		chip->safety_time = chip_tmp->safety_time;
		chip->max_voltage_mv = chip_tmp->max_voltage_mv;
		chip->resume_voltage_delta = chip_tmp->resume_voltage_delta;
		chip->term_current = chip_tmp->term_current;
		chip->cool_temp_dc = chip_tmp->cool_temp_dc;
		chip->warm_temp_dc = chip_tmp->warm_temp_dc;
		chip->temp_check_period = chip_tmp->temp_check_period;
		chip->max_bat_chg_current = chip_tmp->max_bat_chg_current;
		chip->cool_bat_chg_current = chip_tmp->cool_bat_chg_current;
		chip->warm_bat_chg_current = chip_tmp->warm_bat_chg_current;
		chip->cool_bat_voltage = chip_tmp->cool_bat_voltage;
		chip->warm_bat_voltage = chip_tmp->warm_bat_voltage;
		pr_debug("safety_time =          0x%08x  err = %d\n", chip->safety_time, err );
		pr_debug("max_voltage_mv =       0x%08x  err = %d\n", chip->max_voltage_mv, err );
		pr_debug("resume_voltage_delta = 0x%08x  err = %d\n", chip->resume_voltage_delta, err );
		pr_debug("term_current_voltage = 0x%08x  err = %d\n", chip->term_current, err );
		pr_debug("cool_temp_dc =         0x%08x  err = %d\n", chip->cool_temp_dc, err );
		pr_debug("warm_temp_dc =         0x%08x  err = %d\n", chip->warm_temp_dc, err );
		pr_debug("temp_check_period =    0x%08x  err = %d\n", chip->temp_check_period, err );
		pr_debug("max_bat_chg_current =  0x%08x  err = %d\n", chip->max_bat_chg_current, err );
		pr_debug("cool_bat_chg_current = 0x%08x  err = %d\n", chip->cool_bat_chg_current, err );
		pr_debug("warm_bat_chg_current = 0x%08x  err = %d\n", chip->warm_bat_chg_current, err );
		pr_debug("cool_bat_voltage =     0x%08x  err = %d\n", chip->cool_bat_voltage, err );
		pr_debug("warm_bat_voltage =     0x%08x  err = %d\n", chip->warm_bat_voltage, err );
		pr_debug("cool_temp_delta =      0x%08x  err = %d\n", cool_temp_delta, err );
		pr_debug("warm_temp_delta =      0x%08x  err = %d\n", warm_temp_delta, err );
	}
...
static int __pm_batt_external_power_changed_work(struct device *dev, void *data)
{
	...
	int i, dcin_irq;
    int wireless_charge = gpio_get_value( GPIO_CHG_STS ); /* Quad: npdc300089805 */

    /* IDPower: npdc300006191 */
    /* if battery in NOT present, go to shutdown */
    if(pm8921_is_battery_present() == 0)
    {
        pr_err("Battery has been removed.\n"); /* Quad: npdc300089805 */
        if( wireless_charge == WIRELESS_OFF )  /* Quad: npdc300089805 */
        {                                      /* Quad: npdc300089805 */
            pr_err("Battery has been removed. Go to shutdown...\n");
            kernel_power_off();
        }                                      /* Quad: npdc300089805 */
    }
...
{
	int ichg_meas_ua = 0, vbat_uv; /* zantei_jb_VerUp MOD */
	int ichg_meas_ma;
...
#ifndef CONFIG_PM8921_BMS /*<npdc300030059> start */
	int percent_soc;

	if (fgic_set_battery_soc_flg == 1) {
		percent_soc = pm8921_battery_soc;
	}
	else {
		pfgc_fgc_mstate(D_FGC_CAPACITY_REQ, &percent_soc);
	}
...
//			return CHG_IN_PROGRESS;
	...
	if (ichg_meas_ma * -1 > iterm_programmed)
		return CHG_IN_PROGRESS;
#else /* IDPower */
        ichg_meas_ma = get_prop_batt_current(chip);
        pr_debug("iterm_programmed = %d ichg_meas_ma=%d\n",
                                iterm_programmed, ichg_meas_ma);
/* IDPower:npdc300032620        if ( ichg_meas_ma >= 60 ) */
        if ( ichg_meas_ma >= iterm_programmed ) /* IDPower:npdc300032620 */
                return CHG_IN_PROGRESS;
#endif /* IDPower */
...
static void eoc_worker(struct work_struct *work)
{
	...
	int end;
#ifndef CONFIG_PM8921_BMS                     /* IDPower */
	unsigned char data = DCTL_CHG_CHARGE_FIN; /* IDPower */
#endif                                        /* IDPower */
...
#ifndef CONFIG_PM8921_BMS                                  /* IDPower */
			pfgc_fgc_mstate(D_FGC_CHG_INT_IND, &data);     /* IDPower */
#endif                                                     /* IDPower */
...
#if defined(CONFIG_PM8921_BMS) /* IDPower:npdc300033814 */
#define TEMP_HYSTERISIS_DEGC 2
#else                          /* IDPower:npdc300033814 */
#define TEMP_HYSTERISIS_DEGC 20
#endif                         /* IDPower:npdc300033814 */
static void battery_cool(bool enter)
{
//<npdc300035071>	int fsm_state, is_charging;

	pr_info("enter = %d\n", enter);
	if (enter == the_chip->is_bat_cool)
		return;
//<npdc300035071>	fsm_state = pm_chg_get_fsm_state( the_chip );
//<npdc300035071>	is_charging = is_battery_charging( fsm_state );
...
static int configure_btm(struct pm8921_chg_chip *chip)
{
	...
	/* npdc300035887 start */
	mutex_lock(&configure_btm_mutex);
	if( ocv_complete_flg == 0 )
	{
		pr_info("ocv not complete\n");
		mutex_unlock(&configure_btm_mutex);
		return 0;
	}
	if( configure_btm_flg )
	{
		pr_info("configure_btm already called\n");
		mutex_unlock(&configure_btm_mutex);
		return 0;
	}
	configure_btm_flg = 1;
...
static void __devinit determine_initial_state(struct pm8921_chg_chip *chip)
{
	unsigned long flags;
	int fsm_state;
#ifndef CONFIG_PM8921_BMS /* npdc300036415 */
	unsigned char data = DCTL_CHG_NO_CHARGE;
#endif
	...
	pm8921_chg_enable_irq(chip, CHGSTATE_IRQ); /* IDPower:npdc300032594 */
...
#if defined(CONFIG_PM8921_BMS) /* npdc300036415 */
		pm8921_bms_charging_began();
#else /* npdc300036415 */
		data = DCTL_CHG_CHARGE;
		pfgc_fgc_mstate(D_FGC_CHG_INT_IND, &data);
...
#define SAFE_CURRENT_MA		2200 /* IDPower */
//#define SAFE_VDDSAFE_MA		4500 /* IDPower */
#define PM_SUB_REV		0x001
static int __devinit pm8921_chg_hw_init(struct pm8921_chg_chip *chip)
{
	int rc;
	int vdd_safe;
	int temp = 0,vbatdet_temp = 0,ibatmax_temp = 0; /* npdc300035887 */
	u8 subrev;
	...
	if (rc) {
       ...
       if (!(chip->cool_temp_dc == INT_MIN && chip->warm_temp_dc == INT_MIN))
        {
                temp = get_prop_batt_temp(chip);
                if( temp <= chip->cool_temp_dc )
                {
                        /* cool condition */
                        ibatmax_temp = chip->cool_bat_chg_current;
                        vbatdet_temp = chip->cool_bat_voltage - chip->resume_voltage_delta;
                }
                else if( temp >= chip->warm_temp_dc )
                {
                        /* warm condition */
                        ibatmax_temp = chip->warm_bat_chg_current;
                        vbatdet_temp = chip->max_voltage_mv - chip->resume_voltage_delta;
                }
                else
                {
                        ibatmax_temp = chip->max_bat_chg_current;
                        vbatdet_temp = chip->max_voltage_mv - chip->resume_voltage_delta;
                }
                rc = pm_chg_vbatdet_set(chip, vbatdet_temp);
        }
        else
        {
...
//	rc = pm_chg_vddmax_set(chip, chip->max_voltage_mv);
	rc = pm_chg_vddmax_set(chip, PM8921_CHG_VDDMAX_MIN);  /* <npdc300035347> */
	if (rc) {
	...
	if (rc) {
        ...
        if (!(chip->cool_temp_dc == INT_MIN && chip->warm_temp_dc == INT_MIN))
        {
                rc = pm_chg_ibatmax_set(chip, ibatmax_temp);
        }
        else
        {
	...
	if (rc) {
		pr_err("unable to set iusb to 100mA rc = %d\n", rc);
	}
	/* npdc300036401 end */
...
static void create_debugfs_entries(struct pm8921_chg_chip *chip)
{
	...
	debugfs_create_file("CHG_TTRKL_MAX", 0644, chip->dent,
				(void *)CHG_TTRKL_MAX, &reg_fops);
...
/* Jessie add start */
/* Quad del start <npdc300054136>
 *	queue_delayed_work(g_pm8921_wq, &the_chip->wireless_timer_work, 0);
 *	pm8921_dev_dbg("%-40s : queue_delayed_work() - pm8921_wireless_timer_work_func \n", __func__);
 * Quad del end   <npdc300054136> */
/* Jessie add end */
...
/* Jessie add start */
/* Quad del start <npdc300054136>
 *	cancel_delayed_work(&the_chip->wireless_timer_work);
 *	pm8921_dev_dbg("%-40s : cancel_delayed_work() - pm8921_wireless_timer_work_func \n", __func__);
 * Quad del end   <npdc300054136> */
/* Jessie add end */
...
/* Jessie add start */
static irqreturn_t pm8921_wireless_irq_handler(int irq, void *dev_id)
{
        pm8921_dev_dbg_it("%-40s : start \n", __func__);

        disable_irq_nosync(irq);

        queue_work(g_pm8921_wq, &the_chip->wireless_work);
...
static void pm8921_wireless_charge_on(void)
{
	unsigned char data = DCTL_CHG_NO_CHARGE;
...
/* Quad add start */
	...
	gpio_set_value( GPIO_WIRELESS_CHARGE_LEVEL_SHIFTER, WIRELESS_CHARGE_LEVEL_SHIFTER_ENABLE );
	pm8921_dev_dbg("%-40s : GPIO_WIRELESS_CHARGE_LEVEL_SHIFTER : ENABLE \n",__func__);
/* Quad add end */

	// #Jessie_dbg
	if(the_chip->ext_psy){
		power_supply_set_online(the_chip->ext_psy, true);
		power_supply_set_charge_type(the_chip->ext_psy, POWER_SUPPLY_CHARGE_TYPE_FAST);
	}
	power_supply_changed(&the_chip->batt_psy);
	power_supply_changed(&the_chip->dc_psy);

	data = DCTL_CHG_WIRELESS_CHARGE;
	pfgc_fgc_mstate(D_FGC_CHG_INT_IND, &data);
	pm8921_dev_dbg("%-40s : to fgc send : DCTL_CHG_WIRELESS_CHARGE \n",__func__);
...
/* Quad add end */
	...
	mutex_lock(&wrlss_timer_work_mutex);	/* Quad add */
	cancel_delayed_work(&the_chip->wireless_timer_work);
	queue_delayed_work(g_pm8921_wq, &the_chip->wireless_timer_work, 0);
	mutex_unlock(&wrlss_timer_work_mutex);	/* Quad add */

	pm8921_dev_dbg("%-40s : end : Wireless Charging timer start \n",__func__);
}

static void pm8921_wireless_charge_off(void)
{
	unsigned char data = DCTL_CHG_NO_CHARGE;
	...
	pm8921_dev_dbg_it("%-40s : start \n", __func__);
	pm8921_dev_dbg("%-40s : temp_ch_en = %d\n",__func__, temp_ch_en);
	pm8921_dev_dbg("%-40s : safety_ic_charge_sts = %d\n",__func__, safety_ic_charge_sts);
...
/* Quad add end*/
	...
	if((temp_ch_en == 1) && (safety_ic_charge_sts == DSAFETY_CHG_NORMAL) && (wchg_drv_charge_sts == WCHG_CHG_NORMAL)) /* Quad mod:  npdc300052029, npdc300052031 */
	{
		gpio_set_value( GPIO_CHG_SUSPEND, CHG_SUSPEND_OFF );
		pm8921_dev_dbg_it("%-40s : GPIO_CHG_SUSPEND : OFF \n",__func__);
	}
...
/* Quad add end*/
	...
	// #Jessie_dbg
	if(the_chip->ext_psy){
		power_supply_set_online(the_chip->ext_psy, false);
		power_supply_set_charge_type(the_chip->ext_psy, POWER_SUPPLY_CHARGE_TYPE_NONE);
	}
	power_supply_changed(&the_chip->batt_psy);
	power_supply_changed(&the_chip->dc_psy);

	/* USB/AC not Charging */
	is_charging = pm8921_is_battery_charging(&source);
	pm8921_dev_dbg("%-40s : is_charging = %d\n",__func__, is_charging);
	if ( is_charging == false )
	{
		/* SOC check */
		if(fgic_set_battery_soc_flg == 1){
			battery_soc = pm8921_battery_soc;
			pm8921_dev_dbg("%-40s : pm8921_battery_soc = %d\n",__func__, battery_soc);
		}
		else{
			pfgc_fgc_mstate(D_FGC_CAPACITY_REQ, &battery_soc);
			pm8921_dev_dbg("%-40s : pfgc_fgc_mstate(D_FGC_CAPACITY_REQ, &battery_soc) = %d\n",__func__, battery_soc);
		}
		if ( battery_soc == 100 )
		{
			data = DCTL_CHG_WIRELESS_CHG_FIN;
			pfgc_fgc_mstate(D_FGC_CHG_INT_IND, &data);
			pm8921_dev_dbg("%-40s : to fgc send : DCTL_CHG_WIRELESS_CHG_FIN \n",__func__);

			mdelay(15);	/* wait to prevent overwriting FGIC Log */
		}

		data = DCTL_CHG_NO_CHARGE;
		pfgc_fgc_mstate(D_FGC_CHG_INT_IND, &data);
		pm8921_dev_dbg("%-40s : to fgc send : DCTL_CHG_NO_CHARGE \n",__func__);
	}

/* Quad add start*/
	/* Level Shifter Disable */
	gpio_set_value( GPIO_WIRELESS_CHARGE_LEVEL_SHIFTER, WIRELESS_CHARGE_LEVEL_SHIFTER_DISABLE );
	pm8921_dev_dbg("%-40s : GPIO_WIRELESS_CHARGE_LEVEL_SHIFTER : DISABLE \n",__func__);
	
	gpio_set_value( GPIO_WIRELESS_CHARGE_CURRENT_LIMIT, WIRELESS_CHARGE_CURRENT_LIMIT_B );
	pm8921_dev_dbg("%-40s : GPIO_WIRELESS_CHARGE_CURRENT_LIMIT : set limit B (Low) \n",__func__);
/* Quad add end*/

	/* DummyPowerOFF to PowerOFF check is not needed */
}

static void pm8921_wireless_work_func(struct work_struct *work)
{
	int wireless_charge;
	...
	/* Wireless Charge status check */
	if ( wireless_charge == WIRELESS_ON )
	{
		pm8921_dev_dbg("%-40s : Wireless Charge ON \n", __func__);
		pm8921_wireless_charge_on();
	}
	else
	{
		pm8921_dev_dbg("%-40s : Wireless Charge OFF \n", __func__);
		pm8921_wireless_charge_off();
		
		if ((wake_lock_active(&wireless_lock))) {
			wake_unlock(&wireless_lock);
			pm8921_dev_dbg("%-40s : wake_unlock(wireless_lock) \n",__func__);
		}
	}

	/* Enable IRQ */
	enable_irq(gpio_to_irq(GPIO_CHG_STS));
	pm8921_dev_dbg("%-40s : end : enable_irq : GPIO_CHG_STS \n",__func__);
}

static void pm8921_wireless_timer_work_func(struct work_struct *work)
{
	int ret = 0;
	signed short curr = 0;
	int wireless_charge = WIRELESS_OFF;
	...
	pm8921_dev_dbg_it("%-40s : start \n", __func__);
	pm8921_dev_dbg_it("%-40s : wireless_termcnt = %d \n", __func__, wireless_termcnt);
	...
	if ( wireless_charge == WIRELESS_ON )
	{
		pm8921_dev_dbg_it("%-40s : Wireless Charge ON \n",__func__);
...
/* Quad del end */
			...
			/* get current */
			ret = pfgc_fgc_mstate(D_FGC_CURRENT_REQ, &curr);
			pm8921_dev_dbg("%-40s : pfgc_fgc_mstate() ret=%d\n",__func__, ret);

			if ( ret == 0 )
			{
				pm8921_dev_dbg_it("%-40s : pfgc_fgc_mstate() OK : curr = %d mA\n",__func__, curr);

				/* Full check */
/* Quad mod start */
//				if ( ( battery_soc == 100 ) &&
//				     ( curr <= TERM_CURR_WIRELESS ) )
				if( curr <= TERM_CURR_WIRELESS )
/* Quad mod end */
				{
					pm8921_dev_dbg("%-40s : Full check : Full \n",__func__);
					wireless_termcnt ++;
				}
				else
				{
					pm8921_dev_dbg("%-40s : Full check : Not Full \n",__func__);
					wireless_termcnt = 0;
				}
/* Quad add start */
			}
			else {
				pm8921_dev_dbg_it("%-40s : Get Current NG \n",__func__);
				wireless_termcnt = 0;
			}

			/* Full Timer expiration */
/* Quad mod start */
//				if ( wireless_termcnt > BT_FULLTIME_WIRELESS )
			if ( wireless_termcnt == BT_FULLTIME_WIRELESS )
/* Quad mod end */
			{
				pm8921_dev_dbg_it("%-40s : Full Timer expiration \n",__func__);

/* Quad add start*/
				mutex_lock(&wrlss_chg_mutex);
/* Quad add end*/
				gpio_set_value( GPIO_WIRELESS_CHARGE_UART, WIRELESS_CHARGE_FULL_ON );
				pm8921_dev_dbg("%-40s : GPIO_WIRELESS_CHARGE_UART : ON \n",__func__);

				/* wireless charge stop */
				gpio_set_value( GPIO_CHG_SUSPEND, CHG_SUSPEND_ON );
				pm8921_dev_dbg_it("%-40s : GPIO_CHG_SUSPEND : ON \n",__func__);
/* Quad add start*/
				mdelay( WRLSS_CHG_STOP_WAIT_MSEC );
				mutex_unlock(&wrlss_chg_mutex);
/* Quad add end*/
				wireless_termcnt = 0;
			}
/* Quad add start */
				...
				queue_delayed_work(g_pm8921_wq, &the_chip->wireless_timer_work, TEMP_TIMER);
				pm8921_dev_dbg("%-40s : Wireless Charging timer continue \n",__func__);
			}
/* Quad add end */
/* Quad del start */
#if 0
...
/* Quad add start */
			...
			pm8921_dev_dbg_it("%-40s : Wireless Charge Not Full \n",__func__);
			wireless_termcnt = 0;
			if(wake_lock_active(&wireless_lock)) {
				wake_unlock(&wireless_lock);
				pm8921_dev_dbg("%-40s : wake_unlock(wireless_lock) \n",__func__);
...
/* Quad add end */
	...
	{
		pm8921_dev_dbg_it("%-40s : Wireless Charge OFF \n",__func__);

		wireless_termcnt = 0;
		pm8921_dev_dbg("%-40s : Wireless Charging timer stop \n",__func__);
...
/* Jessie add end */
	...
	pm8921_charger_eeprom_read(chip);
...
// Jessie add start
	wake_lock_init(&wireless_lock, WAKE_LOCK_SUSPEND, "wireless_wake_lock" );
// Jessie add end
	...
	enable_irq_wake(chip->pmic_chg_irq[CHGFAIL_IRQ]); /* IDPower:npdc300019191 */
	enable_irq_wake(chip->pmic_chg_irq[CHGSTATE_IRQ]); /* IDPower:npdc300032594 */
	enable_irq_wake(chip->pmic_chg_irq[CHG_GONE_IRQ]);      /* IDPower:npdc300034591 */
	enable_irq_wake(chip->pmic_chg_irq[BATT_REMOVED_IRQ]);  /* IDPower:npdc300034591 */
	enable_irq_wake(chip->pmic_chg_irq[BATT_INSERTED_IRQ]); /* IDPower:npdc300034591 */
#if defined(CONFIG_PM8921_BMS) /*<npdc300034761>*/
	/*
	 * if both the cool_temp_dc and warm_temp_dc are invalid device doesnt
	 * care for jeita compliance
	 */
...
/* Jessie add start */
	...
	INIT_WORK(&chip->wireless_work, pm8921_wireless_work_func);
	INIT_WORK(&chip->chgfail_work, pm8921_chgfail_work_func);	/* Quad add */

	INIT_DELAYED_WORK(&chip->wireless_timer_work, pm8921_wireless_timer_work_func);

	/* Initialize GPIO setting */
	ret = gpio_request(GPIO_CHG_STS, "CHG_STS");
	pm8921_dev_dbg("%-40s : gpio_request(GPIO_CHG_STS) ret=%d\n",__func__, ret);

	if (ret) {
		pr_err("pm8921 : cannot request gpio charge sts int \n");
	}
	gpio_direction_input(GPIO_CHG_STS);
	gpio_export(GPIO_CHG_STS, 0);	/* Quad add. export wireless charging status to user space */

	ret = gpio_request(GPIO_CHG_SUSPEND, "CHG_SUSPEND");
	pm8921_dev_dbg("%-40s : gpio_request(GPIO_CHG_SUSPEND) ret=%d\n",__func__, ret);

	if (ret) {
		pr_err("pm8921 : cannot request gpio charge suspend \n");
	}
	gpio_direction_output(GPIO_CHG_SUSPEND, 0);

	ret = gpio_request(GPIO_WIRELESS_CHARGE_UART, "WIRELESS_CHARGE_UART");
	pm8921_dev_dbg("%-40s : gpio_request(WIRELESS_CHARGE_UART) ret=%d\n",__func__, ret);

	if (ret) {
		pr_err("pm8921 : cannot request gpio wireless charge uart \n");
	}
	gpio_direction_output(GPIO_WIRELESS_CHARGE_UART, WIRELESS_CHARGE_FULL_OFF);

	ret = gpio_request(GPIO_WIRELESS_CHARGE_LED_MASK, "WIRELESS_CHARGE_LED_MASK");
	pm8921_dev_dbg("%-40s : gpio_request(WIRELESS_CHARGE_LED_MASK) ret=%d\n",__func__, ret);

	if (ret) {
		pr_err("pm8921 : cannot request gpio wireless charge led mask \n");
	}
	gpio_direction_output(GPIO_WIRELESS_CHARGE_LED_MASK, 0);

	/* Charge LED control by software */
	gpio_set_value( GPIO_WIRELESS_CHARGE_LED_MASK, WIRELESS_CHARGE_AUTO_LED_MASK );
	pm8921_dev_dbg("%-40s : GPIO_WIRELESS_CHARGE_LED_MASK : MASK \n",__func__);

/* Quad add start */
	ret = gpio_request(GPIO_WIRELESS_CHARGE_LEVEL_SHIFTER, "WIRELESS_CHARGE_LEVEL_SHIFTER");
	pm8921_dev_dbg("%-40s : gpio_request(WIRELESS_CHARGE_LEVEL_SHIFTER) ret=%d\n",__func__, ret);

	if (ret) {
		pr_err("pm8921 : cannot request gpio wireless charge level shifter \n");
	}
	gpio_direction_output(GPIO_WIRELESS_CHARGE_LEVEL_SHIFTER, 0);

	/* Level Shifter Disable */
	gpio_set_value( GPIO_WIRELESS_CHARGE_LEVEL_SHIFTER, WIRELESS_CHARGE_LEVEL_SHIFTER_DISABLE );
	pm8921_dev_dbg("%-40s : GPIO_WIRELESS_CHARGE_LEVEL_SHIFTER : DISABLE \n",__func__);

	ret = gpio_request(GPIO_WIRELESS_CHARGE_CURRENT_LIMIT, "WIRELESS_CHARGE_CURRENT_LIMIT");
	pm8921_dev_dbg("%-40s : gpio_request(WIRELESS_CHARGE_CURRENT_LIMIT) ret=%d\n",__func__, ret);

	if (ret) {
		pr_err("pm8921 : cannot request gpio wireless charge current limit \n");
	}
	gpio_direction_output(GPIO_WIRELESS_CHARGE_CURRENT_LIMIT, 0);

	/* Current Limit B (Low) */
	gpio_set_value( GPIO_WIRELESS_CHARGE_CURRENT_LIMIT, WIRELESS_CHARGE_CURRENT_LIMIT_B );
	pm8921_dev_dbg("%-40s : GPIO_WIRELESS_CHARGE_CURRENT_LIMIT : B \n",__func__);
	
	init_completion(&pulse_completion);
	hrtimer_init(&pulse_timer, CLOCK_MONOTONIC, HRTIMER_MODE_REL);
	pulse_timer.function = pulse_timeout;
	
	init_completion(&charge_off_reason_completion);
	hrtimer_init(&charge_off_reason_timer, CLOCK_MONOTONIC, HRTIMER_MODE_REL);
	charge_off_reason_timer.function = charge_off_reason_timeout;
/* Quad add end */

	/* Wireless Charge status get */
	wireless_charge = gpio_get_value(GPIO_CHG_STS);
	pm8921_dev_dbg("%-40s : wireless_charge=0x%x\n",__func__, wireless_charge);
	...
	{
		pm8921_dev_dbg_it("%-40s : Wireless Charge ON \n",__func__);
/* Quad add start <npdc300057681> */
		gpio_set_value( GPIO_WIRELESS_CHARGE_LEVEL_SHIFTER, WIRELESS_CHARGE_LEVEL_SHIFTER_ENABLE );
		wrlss_curr_limit_off();
/* Quad add end   <npdc300057681> */
		pm8921_wireless_charge_on();
	}
	else
	{
	...
	/* Set irq */
	enable_irq_wake(gpio_to_irq(GPIO_CHG_STS));
	ret = request_irq(gpio_to_irq(GPIO_CHG_STS),
		pm8921_wireless_irq_handler,
		IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING,
		"charger_chgsts", chip);
	pm8921_dev_dbg("%-40s : request_irq(GPIO_CHG_STS) ret=%d\n",__func__, ret);

	if (unlikely(ret)) {
		pr_err("pm8921 : chgsts request irq error ret = %d\n", ret);
		goto request_wireless_irq_fail;
	}
/* Jessie add end */
	return 0;

/* Jessie add start */
request_wireless_irq_fail:
	free_irq(gpio_to_irq(GPIO_CHG_STS), chip);
	pm8921_dev_dbg("%-40s : free_irq(GPIO_CHG_STS) ret=%d\n",__func__, ret);
	rc = ret;
/* Jessie add end */
...
/* Jessie add start */
	free_irq(gpio_to_irq(GPIO_CHG_STS), chip);
	pm8921_dev_dbg("%-40s : free_irq(GPIO_CHG_STS) \n",__func__);
	flush_workqueue(g_pm8921_wq);
/* Jessie add end */
...
{
/* Jessie add start */
	g_pm8921_wq = create_singlethread_workqueue("pm8921_wq");
	pm8921_dev_dbg("%-40s : create_singlethread_workqueue(\"pm8921_wq\") \n",__func__);
	if (!g_pm8921_wq) {
		pm8921_dev_dbg("%-40s : g_pm8921_wq = NULL \n",__func__);
		return -ENOMEM;
	}
/* Jessie add end */
