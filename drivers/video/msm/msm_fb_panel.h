...
struct msm_fb_panel_data {
	...
	int (*sysfs_register) (struct device *dev);
	void (*sysfs_unregister) (struct device *dev);
	void (*pre_on) (struct msm_fb_data_type *mfd);
	void (*pre_off) (struct msm_fb_data_type *mfd);
};
