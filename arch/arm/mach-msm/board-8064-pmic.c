...
static struct pm8xxx_gpio_init pm8921_gpios[] __initdata = {
	PM8921_GPIO_OUTPUT(2, 0, HIGH),	/* MM tuner RST */
/* <Quad> Del Start */
#if 0
...
#endif
/* <Quad> Del End */
	PM8921_GPIO_OUTPUT(25, 0, HIGH),    /* <Quad> Mod */
	PM8921_GPIO_OUTPUT_FUNC(26, 0, PM_GPIO_FUNC_2), /* Bl: Off, PWM mode */
        PM8921_GPIO_OUTPUT_FUNC(37, 0, PM_GPIO_FUNC_NORMAL),     /* Bl: Off, DCDC     */
	PM8921_GPIO_OUTPUT(30, 1, HIGH), /* NFC_FLT */
	PM8921_GPIO_OUTPUT_VIN(36, 0, PM_GPIO_VIN_VPH), /* <Quad> Mod */
//	PM8921_GPIO_OUTPUT_FUNC(44, 0, PM_GPIO_FUNC_2), /* <Quad> Del */
...
/* Quad ADD START 12/07/24 */
	PM8921_GPIO_INPUT(15, PM_GPIO_PULL_UP_30),  /* Hard BACK key */
	PM8921_GPIO_INPUT(27, PM_GPIO_PULL_UP_30),  /* Hard HOME key */
	PM8921_GPIO_INPUT(9, PM_GPIO_PULL_UP_30),   /* Hard MENU key */
/* Quad ADD END   12/07/24 */
	PM8921_GPIO_OUTPUT(16, 0, HIGH),      /* LCD: DCDC         */

	/* TABLA CODEC RESET */
	PM8921_GPIO_OUTPUT(34, 1, MED),
	PM8921_GPIO_INPUT(31, PM_GPIO_PULL_NO),
//	PM8921_GPIO_OUTPUT(13, 0, HIGH),               /* PCIE_CLK_PWR_EN */    /* <Quad> Del */
	
	/* RUPY ADD-S */
	PM8921_GPIO_OUTPUT(  1 , 0 , HIGH ) ,            /* NFC_FW FC_PON */
//	PM8921_GPIO_OUTPUT(  2 , 0 , HIGH ) ,            /* nDTV_RST      */    /* <Quad> Del */
	PM8921_GPIO_OUTPUT(  5 , 0 , HIGH ) ,            /* IR_PDN        */    /* <Quad> Mod */
	PM8921_GPIO_OUTPUT_VIN(  6 , 0 , PM_GPIO_VIN_VPH ), /* DCIN_ON    */    /* <Quad> Mod */
    PM8921_GPIO_OUTPUT(  7 , 0 , HIGH ) ,            /* NFC_EXT_EN    */
//	PM8921_GPIO_INPUT(   9 , PM_GPIO_PULL_UP_30 ),   /* MENU_KEY      */    /* <Quad> Del */
  PM8921_GPIO_OUTPUT_VIN( 10 , 0 , PM_GPIO_VIN_VPH ) , /* WCHG_SUSPEND  */    /* <Quad> Mod */
  PM8921_GPIO_OUTPUT_VIN( 11 , 0 , PM_GPIO_VIN_VPH ) , /* WCHG_FETCNT   */    /* <Quad> Mod */
//	PM8921_GPIO_INPUT(  15 , PM_GPIO_PULL_UP_30 ),   /* BACK_KEY      */    /* <Quad> Del */
	PM8921_GPIO_OUTPUT( 18 , 0 , HIGH ) ,            /* SPKR_LEFT_EN  */
//	PM8921_GPIO_INPUT(  27 , PM_GPIO_PULL_UP_30 ),   /* HOME_KEY      */    /* <Quad> Del */
//	PM8921_GPIO_OUTPUT_VIN( 30 , 1 , PM_GPIO_VIN_VPH ), /* NFC_FLT    */    /* <Quad> Del */
	PM8921_GPIO_OUTPUT( 42 , 1 , HIGH ) ,            /* WCHG_LS_EN    */    /* <Quad> Mod */
	/* RUPY ADD-E */
...
/* <Quad> Add Start */
	...
	PM8921_GPIO_INPUT( 17, PM_GPIO_PULL_DN ),
	PM8921_GPIO_INPUT( 19, PM_GPIO_PULL_DN ),
	PM8921_GPIO_INPUT( 21, PM_GPIO_PULL_DN ),
	PM8921_GPIO_INPUT( 22, PM_GPIO_PULL_DN ),
	PM8921_GPIO_INPUT( 23, PM_GPIO_PULL_DN ),
	PM8921_GPIO_INPUT( 24, PM_GPIO_PULL_DN ),
	PM8921_GPIO_INPUT( 28, PM_GPIO_PULL_DN ),
	PM8921_GPIO_OUTPUT( 29, 1, HIGH ), /* NFC_FLT */
	PM8921_GPIO_INPUT( 31, PM_GPIO_PULL_DN ),
...
/* <Quad> Mod Start */
	...
	PM8921_MPP_INIT(PM8XXX_AMUX_MPP_4, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH6, DOUT_CTRL_LOW), /* IDPower for SafetyIC */
    PM8921_MPP_INIT(PM8XXX_AMUX_MPP_7, D_OUTPUT, PM8921_MPP_DIG_LEVEL_S4, DOUT_CTRL_LOW), /* IDPower GPIO(ISV) */   /* <Quad> Add */
#else
	PM8921_MPP_INIT(  1, SINK, PM8XXX_MPP_CS_OUT_5MA, CS_CTRL_DISABLE ),
	PM8921_MPP_INIT(  2, SINK, PM8XXX_MPP_CS_OUT_5MA, CS_CTRL_DISABLE ),
	PM8921_MPP_INIT(  3, SINK, PM8XXX_MPP_CS_OUT_5MA, CS_CTRL_DISABLE ),
	PM8921_MPP_INIT(PM8XXX_AMUX_MPP_4, A_INPUT, PM8XXX_MPP_AIN_AMUX_CH6, DOUT_CTRL_LOW), /* IDPower for SafetyIC */
	PM8921_MPP_INIT(  7, SINK, PM8XXX_MPP_CS_OUT_5MA, CS_CTRL_DISABLE ),
	PM8921_MPP_INIT(  8, SINK, PM8XXX_MPP_CS_OUT_5MA, CS_CTRL_DISABLE ),
...
static struct pm8xxx_adc_amux apq8064_pm8921_adc_channels_data[] = {
	...
	{"pa_therm1", ADC_MPP_1_AMUX6, CHAN_PATH_SCALING1, AMUX_RSV1,
...
apq8064_pm8921_rtc_pdata = {
	/* IDP AlarmWatch: Enable RTC write */
...
#define MAX_VOLTAGE_MV		4340	//iD POWER Battery Charge
...
/* Quad mod start. Request from hardware team */
/*	.trkl_current   = 100, */ /* IDPower */
	.trkl_current   = 200,
/* Quad mod end */
	.keep_btm_on_suspend	= 1, /* IDPower warm_cool */
	.ttrkl_time		= 30,   /* npdc300035314 */
/*<npdc300059852>	.weak_voltage	= 3000, *//* npdc300035314 */
	.weak_voltage	= 2800, /* <npdc300059852> */
	.rconn_mohm		= 18,
};
...
// RED_LED EXISP code
static struct pm8xxx_vibrator_platform_data apq8064_pm8xxx_redled_pdata __devinitdata = {
...
apq8064_pm8921_platform_data __devinitdata = {
	...
	.vibrator_pdata		= &apq8064_pm8xxx_redled_pdata,  // RED_LED EXISP code
};
