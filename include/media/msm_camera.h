...
#define MSM_CAM_RESP_EXISP_EVT_MSG     8
#define MSM_CAM_RESP_MAX               9
...
#if 1  /* EXISP code */
#define MSM_PMEM_POSTVIEW       20
#define MSM_PMEM_MAX            21
#else
...
//EXISP Code
#define MSM_V4L2_PID_DIRECTION				(V4L2_CID_PRIVATE_BASE+19)
#define MSM_V4L2_PID_HDR					(V4L2_CID_PRIVATE_BASE+20)
#define MSM_V4L2_PID_VIDEO_STABILIZATION	(V4L2_CID_PRIVATE_BASE+21)
#define MSM_V4L2_PID_SNAPSHOT_STABILIZATION	(V4L2_CID_PRIVATE_BASE+22)
#define MSM_V4L2_PID_I_EXPOSURE				(V4L2_CID_PRIVATE_BASE+23)
#define MSM_V4L2_PID_FACE_AF				(V4L2_CID_PRIVATE_BASE+24)
#define MSM_V4L2_PID_SEQUENTIAL_SHOOTING	(V4L2_CID_PRIVATE_BASE+25)
#define MSM_V4L2_PID_1SHOTAF_LIGHT			(V4L2_CID_PRIVATE_BASE+26)
#define MSM_V4L2_PID_IMAGE_STRENGTH			(V4L2_CID_PRIVATE_BASE+27)
#define MSM_V4L2_PID_CAMERA_RESET			(V4L2_CID_PRIVATE_BASE+28)	/* for camera_reset */

#define MSM_V4L2_PID_MAX                    (V4L2_CID_PRIVATE_BASE+29)
...
#define CFG_SET_EXISP_AF_CANCEL       47    /* kesasaki JB */
#define CFG_SET_EXISP_AF_STOP         48
#define CFG_GET_EXISP_AF_STATS        49
#if 1 /* EXISP code */
#define CFG_SET_EXISP_BESTSHOT		  50
#define CFG_SET_EXISP_AEC_LOCK		  51
#define CFG_SET_EXISP_AWB_LOCK		  52
#define CFG_SET_TERMINAL_DIRECTION    53
#define CFG_SET_HDRMODE               54
#define CFG_SET_STABILIZATION         55
#define CFG_SET_IEXPOSURE             56
#define CFG_GET_SNAPSHOT_EXISP		  57	//Exif Support::add
#define CFG_GET_MAKERNOTE_EXISP		  58	//Exif Support::add
#define CFG_CAMERA_RESET			  59
#define CFG_SET_EXISP_AF_MODE         60
#define CFG_SET_EXISP_CAF_MODE        61
#define CFG_SET_EXISP_AF_MTR_AREA     62
#define CFG_SET_EXISP_FLASH_SET_MODE  63
#define CFG_SET_EXISP_FACE_AF		  64
#define CFG_SET_EXISP_SEQUENTIAL_SHOOTING	65
#define CFG_SET_EXISP_1SHOTAF_LIGHT	  66
#define CFG_SET_EXISP_IMAGE_STRENGTH  67
#define CFG_GET_FOCUS_DISTANCE_EXISP  68
#define CFG_GET_EXISP_OMAKASE_INFO    69
#define CFG_GET_EXISP_FOCUS_DISTANCE_INFO    70
#define CFG_MAX                       71
#else
#define CFG_MAX			47
#endif /* EXISP code */		
...
#if 1 /* EXISP code */
#define EXISP_CAMERA_EFFECT_BEAUTYSKIN	12
#define EXISP_CAMERA_EFFECT_CHIC	13
#define EXISP_CAMERA_EFFECT_FANTASY	14
#define EXISP_CAMERA_EFFECT_NOSTALGIA	15
#define EXISP_CAMERA_EFFECT_PINHOLE	16
#define EXISP_CAMERA_EFFECT_POP		17
#define EXISP_CAMERA_EFFECT_PURE	18
#define EXISP_CAMERA_EFFECT_SOFTFOCUS	19
#define EXISP_CAMERA_EFFECT_TOY		20
#define CAMERA_EFFECT_MAX		21
#else
...
/* EXISP Code::add S */
#define CAMERA_STABILIZATION_OFF		0
#define CAMERA_STABILIZATION_ON			1

#define CAMERA_HDRMODE_OFF		0
#define CAMERA_HDRMODE_ON		1

#define CAMERA_IEXPOSURE_OFF	0
#define CAMERA_IEXPOSURE_ON		1

#define EXISP_CAMERA_FACE_AF_OFF	0
#define EXISP_CAMERA_FACE_AF_ON	1
#define EXISP_CAMERA_FACE_AF_BACKLIGHT	2

#define EXISP_CAMERA_SEQUENTIAL_SHOOTING_OFF	0
#define EXISP_CAMERA_SEQUENTIAL_SHOOTING_NORMAL_ON	1
#define EXISP_CAMERA_SEQUENTIAL_SHOOTING_NIGHTSHOT_ON	2

#define EXISP_CAMERA_1SHOTAF_LIGHT_OFF	0
#define EXISP_CAMERA_1SHOTAF_LIGHT_AUTO	1

#define EXISP_IMAGE_STRENGTH_WEAK 0
#define EXISP_IMAGE_STRENGTH_STRONG 1

typedef enum {
	STABILIZATION_KIND_VIDEO,
	STABILIZATION_KIND_SNAPSHOT
} sensor_stabilization_kind_t;

typedef struct {
  sensor_stabilization_kind_t kind;
  uint8_t onoff;
} sensor_stabilization_t;
/* EXISP Code Parm::add E */
...
typedef struct {
	...
	uint8_t  flash;
} sensor_snapshot_info_t;

#define SENSOR_MAKERNOTE_SIZE	104
typedef struct {
	uint8_t data[SENSOR_MAKERNOTE_SIZE];
} sensor_makernote_info_t;
/* Exif Support::add S */
...
/* EXISP code start */
#define SENSOR_OMAKASE_SIZE 7
typedef struct {
	uint8_t data[SENSOR_OMAKASE_SIZE];
} sensor_omakase_info_t;

#define SENSOR_FOCUS_DISTANCE_SIZE 1
typedef struct {
	uint8_t data[SENSOR_FOCUS_DISTANCE_SIZE];
} sensor_focus_distance_info_t;
/* EXISP code end */
...
struct sensor_cfg_data {
	...
	union {
		...
		exisp_state_t exisp_af;
#if 1 /* EXISP code */
		uint8_t exisp_bestshot;
		uint8_t exisp_aec_lock;
		uint8_t exisp_awb_lock;
		uint8_t terminal_direction;
		uint8_t hdrmode;
		uint8_t i_exposure;
		sensor_stabilization_t stabilization;
		sensor_snapshot_info_t snapshot_info;		//Exif Support::add
		sensor_makernote_info_t makernote_info;		//Exif Support::add
		uint8_t zoomvalue;							//EXISP Zoom::add
		...
		uint8_t face_af;
		uint8_t sequential_shooting;
		uint8_t oneshotaf_light;
		uint8_t image_strength;
		uint8_t exisp_focus_distance;
		sensor_omakase_info_t exisp_omakase_info;
		sensor_focus_distance_info_t exisp_focus_distance_info;
#endif /* EXISP code */
	} cfg;
};
