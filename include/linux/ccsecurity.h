...
#define	MAX_ONE_CHARACTERSIZE		16
#define	MAX_ANTI_COMM_NUMS	10
#define	MAX_ALL_CHARACTERSIZE		(MAX_ANTI_COMM_NUMS * MAX_ONE_CHARACTERSIZE)
#define	CCS_FILE_ERROR		255
extern unsigned char anti_comm_name[MAX_ANTI_COMM_NUMS][MAX_ONE_CHARACTERSIZE];
extern unsigned char anti_comm_nums;
