...
#define TSIF_0_CLK GPIO_CFG (55, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)
#define TSIF_0_EN GPIO_CFG  (56, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)
#define TSIF_0_DATA GPIO_CFG(57, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)
#define TSIF_0_SYNC GPIO_CFG(62, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)
#define TSIF_1_CLK GPIO_CFG (59, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)
#define TSIF_1_EN GPIO_CFG  (60, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)
#define TSIF_1_DATA GPIO_CFG(61, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)
#define TSIF_1_SYNC GPIO_CFG(58, 1, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA)
...
struct platform_device apq8064_device_tsif[2] = {
	{
		.name = "msm_tsif",
		.id = 0,
...
/*Quad IrDA ADD Start */
static struct msm_serial_hslite_platform_data uart_gsbi3_pdata = {
        .config_gpio    = 1,
        .uart_tx_gpio   = 6,
        .uart_rx_gpio   = 7,
        .line           = 1,
...
/*Quad IrDA ADD Start */
	.dev.platform_data = &uart_gsbi3_pdata,
/*Quad IrDA ADD END */
};
...
static struct resource resources_qup_spi_gsbi5[] = {
	...
	{
	.name = "spidm_crci",
	.start = 9, //GSBI5_IN_CRCI
	.end = 10, //GSBI5_OUT_CRCI
	.flags = IORESOURCE_DMA,
	},
	{
	.name = "spi_clk",
	.start = 54, 		//GPIO for SPI_CLK
	.end = 54,
	.flags = IORESOURCE_IO,
	},
	{
	.name = "spi_cs",
	.start = 53, 		//GPIO for SPI_CS
	.end = 53,
	.flags = IORESOURCE_IO,
	},
#if 0
...
// <Quad> add 0918 S
static struct msm_serial_hslite_platform_data uart_gsbi7_pdata = {
        .line           = 0,
};
// <Quad> add 0918 E
...
// <Quad> add 0918 S
	.dev.platform_data = &uart_gsbi7_pdata,
// <Quad> add 0918 E
};
