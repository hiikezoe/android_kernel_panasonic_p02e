...
/* PMC-Viana-025-Totoro組み込み対応 start */
#define EXPORT_IPSEC_SYMBOL
#ifdef EXPORT_IPSEC_SYMBOL
EXPORT_SYMBOL(inet_protos);
/* PMC-Viana-026-NEMO組み込み対応 delete start */
//EXPORT_SYMBOL(inet_proto_lock);
/* PMC-Viana-026-NEMO組み込み対応 delete end */
#endif /* EXPORT_IPSEC_SYMBOL */
/* PMC-Viana-025-Totoro組み込み対応 end */
