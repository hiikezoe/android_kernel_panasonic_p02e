...
static char adcmap_btm_threshold_flag; /* IDPower npdc300034410 */
...
/* IDPower npdc300034410 start */
static const struct pm8xxx_adc_map_pt adcmap_btm_threshold_1[] = {
	{-300,	1638},
	{-200,	1549},
	{-100,	1430},
	{0,	1284},
		...
		struct pm8xxx_adc_chan_result *adc_chan_result)
{
	...
	if(adcmap_btm_threshold_flag == 0){    /* IDPower npdc300034410 */
	...
	else{    /* IDPower npdc300034410 */
	return pm8xxx_adc_map_batt_therm(
			adcmap_btm_threshold_1,
			ARRAY_SIZE(adcmap_btm_threshold_1),
			bat_voltage,
			&adc_chan_result->physical);
	}    /* IDPower npdc300034410 */
}
...
/* <IDPower> ADC by SafetyIC start */
	if(safety_adc_flg == true){
		/* printk("pa_voltage = %lld(0x%llx)\n", pa_voltage, pa_voltage); */
		adc_chan_result->physical = pa_voltage;
		return 0;
	}
/* <IDPower> ADC by SafetyIC end */
...
/* IDPower npdc300034410 start */
int32_t pm8xxx_adc_set_btm_threshold(int value)
{
	if(value == 1){
		adcmap_btm_threshold_flag = 1;
	}
	else{
		adcmap_btm_threshold_flag = 0;
	}

	return 0;
}
EXPORT_SYMBOL_GPL(pm8xxx_adc_set_btm_threshold);
/* IDPower npdc300034410 end */
