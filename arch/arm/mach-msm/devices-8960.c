...
#else	/* BUS_BW_CUSTOM */
		.ab  = (1920 * 1080 * 4 * 2 * 60),		/*   995M */
		.ib  = (1920 * 1080 * 4 * 2 * 60 * 1.5),	/* 1,493M */
#endif	/* BUS_BW_CUSTOM */
	},
};
...
#else	/* BUS_BW_CUSTOM */
		.ab  = (640 * 480 * 2 * 2 * 60),		/*    74M */
		.ib  = (640 * 480 * 2 * 2 * 60 * 1.5),		/*   111M */
#endif	/* BUS_BW_CUSTOM */
	},
};
...
#else	/* BUS_BW_CUSTOM */
		.ab  = (1280 * 736 * 2 * 2 * 60),		/*   226M */
		.ib  = (1280 * 736 * 2 * 2 * 60 * 1.5),		/*   339M */
#endif	/* BUS_BW_CUSTOM */
	},
};
...
#else	/* BUS_BW_CUSTOM */
		.ab  = (1920 * 1088 * 2 * 2 * 60),		/*   501M */
		.ib  = 0x60DB8840,				/* 1,625M */
#endif	/* BUS_BW_CUSTOM */
	},
};
