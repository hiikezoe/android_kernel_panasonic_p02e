...
struct msm_sensor_fn_t {
	...
	int32_t (*exisp_sensor_set_af_mode) (struct msm_sensor_ctrl_t *, uint32_t);
	int32_t (*exisp_sensor_set_caf_mode) (struct msm_sensor_ctrl_t *, uint32_t);
	int32_t (*exisp_sensor_set_af_mtr_area) (struct msm_sensor_ctrl_t *, exisp_af_mtr_area_t);
	int32_t (*exisp_sensor_set_led_mode) (struct msm_sensor_ctrl_t *, exisp_led_mode_t);
};
...
typedef struct exisp_sensor_ctrl_s {
        spinlock_t     slock;
        exisp_enable_t enable;
        exisp_state_t  state;
		exisp_doing_t  doing;
        bool hdr_mode;
        exisp_af_mode_type_t af_mode;
        exisp_af_mtr_area_t af_mtr_area;
        exisp_led_mode_t led_mode;
#if 1	/* cam_reset */
        exisp_caf_mode_type_t caf_mode;
        int	zoom;
        int wb;
        int scene_mode;
        int direction;
        ...
        int iso;
        int af_light;
        int stabilization_photo;
        int stabilization_video;
        int face;
        int supernights;
        int ae_lock;
        int wb_lock;
