...
//static int msm_headset_gpios_configured; /* Quad DEL */
...
static const struct snd_soc_dapm_route apq8064_common_audio_map[] = {
	...
	/* Speaker path */
	{"Ext Spk Top Pos", NULL, "LINEOUT1"},  /* modify Bottom -> Top */
	{"Ext Spk Top Neg", NULL, "LINEOUT3"},  /* modify Bottom -> Top */
...
#endif /* CONFIG_SND_SOC_MSM_QDSP6_HDMI_AUDIO */
...
//	msm_free_headset_mic_gpios(); /* Quad DEL */
