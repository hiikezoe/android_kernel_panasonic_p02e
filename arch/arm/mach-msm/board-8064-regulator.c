...
VREG_CONSUMERS(L8) = {
	...
	REGULATOR_SUPPLY("wchg_vdd",		NULL),
};
VREG_CONSUMERS(L9) = {
...
VREG_CONSUMERS(L16) = {
	...
	REGULATOR_SUPPLY("cam_vaf",		"4-0060"),
	REGULATOR_SUPPLY("cam_vaf",		"4-0061"),
...
VREG_CONSUMERS(L17) = {
	...
	REGULATOR_SUPPLY("lcd_dcdc",		"mipi_dsi.1"),
};
VREG_CONSUMERS(L18) = {
...
VREG_CONSUMERS(S4) = {
	...
	//REGULATOR_SUPPLY("vcc_i2c",		"3-005b"), /* Quad DEL */
	REGULATOR_SUPPLY("vcc_i2c",		"3-0024"),
/* Quad ADD START 12/8/2 */
  REGULATOR_SUPPLY("vddp",		"1-005a"),
...
VREG_CONSUMERS(S8) = {
	...
	REGULATOR_SUPPLY("cam_8921_S8",	"4-0060"),
	REGULATOR_SUPPLY("cam_8921_S8",	"4-0061"),
};
VREG_CONSUMERS(LVS1) = {
...
VREG_CONSUMERS(LVS5) = {
	...
	REGULATOR_SUPPLY("cam_vio",		"4-0061"),
...
#if 1 /* EXISP code */
	RPM_SMPS(S8, 0, 1, 0, 1200000, 2200000, NULL,      0, 1p60, NONE, NONE),    /* <Quad> Mod */
#else
	RPM_SMPS(S8, 0, 1, 0, 1200000, 2200000, NULL,      0, 1p60, AUTO, AUTO),    /* <Quad> Mod */
#endif
...
#if 1 /* EXISP code */
	RPM_LDO(L11, 0, 1, 0, 2700000, 3000000, NULL,          0,     0),
#else
...
/*Quad IrDA MOD END */
	RPM_LDO(L22, 0, 1, 0, 2850000, 2850000, NULL,          0,     0),   /* <Quad> Mod */
