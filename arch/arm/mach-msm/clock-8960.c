...
/*<rupy>	CLK_LOOKUP("core_clk",		gsbi1_uart_clk.c, "msm_serial_hsl.1"),*/
	CLK_LOOKUP("core_clk",		gsbi1_uart_clk.c, ""),/*<rupy>*/
	CLK_LOOKUP("core_clk",		gsbi2_uart_clk.c,	""),
/*<rupy>	CLK_LOOKUP("core_clk",		gsbi3_uart_clk.c,	""),*/
/*<rupy>	CLK_LOOKUP("core_clk",		gsbi4_uart_clk.c,	""),*/
	CLK_LOOKUP("core_clk",		gsbi3_uart_clk.c,	"msm_serial_hsl.1"),/*<rupy>*/
	CLK_LOOKUP("core_clk",		gsbi4_uart_clk.c,	"msm_serial_hsl.0"),/*<rupy>*/
	CLK_LOOKUP("core_clk",		gsbi5_uart_clk.c,	""),
	CLK_LOOKUP("core_clk",		gsbi6_uart_clk.c,	""),
/*<rupy>        CLK_LOOKUP("core_clk",          gsbi7_uart_clk.c, "msm_serial_hsl.0"),*/
/*	CLK_LOOKUP("core_clk",		gsbi7_uart_clk.c, "msm_serial_hsl.2"),<rupy>*/
/* <Quad> mod */
	CLK_LOOKUP("core_clk",		gsbi7_uart_clk.c, "msm_serial_hsl2"),
	CLK_LOOKUP("core_clk",		gsbi1_qup_clk.c,	"qup_i2c.1"),
/*<rupy>	CLK_LOOKUP("core_clk",		gsbi2_qup_clk.c,	""),*/
	CLK_LOOKUP("core_clk",		gsbi2_qup_clk.c,	"qup_i2c.2"),/*<rupy>*/
...
/*<rupy>	CLK_LOOKUP("core_clk",		gsbi7_qup_clk.c,	""),*/
	CLK_LOOKUP("core_clk",		gsbi7_qup_clk.c,	"qup_i2c.7"),/*<rupy>*/
...
/*	CLK_LOOKUP("ref_clk",		tsif_ref_clk.c,		""), */                    /* APQ8064用対応 TSIF.pdf.pdf */
...
/*<rupy>	CLK_LOOKUP("iface_clk",		gsbi1_p_clk.c,	"msm_serial_hsl.1"),*/
/*<rupy>	CLK_LOOKUP("iface_clk",		gsbi1_p_clk.c,	"qup_i2c.0"),*/
	CLK_LOOKUP("iface_clk",		gsbi1_p_clk.c,	"qup_i2c.1"),/*<rupy>*/
/*<rupy>	CLK_LOOKUP("iface_clk",		gsbi2_p_clk.c,		""),*/
	CLK_LOOKUP("iface_clk",		gsbi2_p_clk.c,		"qup_i2c.2"),/*<rupy>*/
	CLK_LOOKUP("iface_clk",		gsbi3_p_clk.c,	"msm_serial_hsl.1"),/*<rupy>*/
	CLK_LOOKUP("iface_clk",		gsbi3_p_clk.c,		"qup_i2c.3"),
	CLK_LOOKUP("iface_clk",		gsbi4_p_clk.c,	"msm_serial_hsl.0"),/*<rupy>*/
...
/*<rupy>        CLK_LOOKUP("iface_clk",         gsbi7_p_clk.c,  "msm_serial_hsl.0"),*/
/*	CLK_LOOKUP("iface_clk",		gsbi7_p_clk.c,	"msm_serial_hsl.2"),<rupy>*/
/* <Quad> mod */
	CLK_LOOKUP("iface_clk",		gsbi7_p_clk.c,	"msm_serial_hsl2"),
/* <Quad> del */
	CLK_LOOKUP("iface_clk",		gsbi7_p_clk.c,		"qup_i2c.7"),/*<rupy>*/
	CLK_LOOKUP("ref_clk",	tsif_ref_clk.c,	"msm_tspp.0"),
/*	CLK_LOOKUP("iface_clk",		tsif_p_clk.c,		"msm_tspp.0"), */                    /* APQ8064用対応 TSIF.pdf.pdf */
	...
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0060"),	
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0061"),
...
/* IDPower	CLK_LOOKUP("core_clk",		gsbi1_qup_clk.c,	"spi_qsd.0"), */
	CLK_LOOKUP("core_clk",		gsbi1_qup_clk.c,	"qup_i2c.1"), /* IDPower */
	...
	CLK_LOOKUP("dma_bam_pclk",	dma_bam_p_clk.c,	NULL),
/* IDPower	CLK_LOOKUP("iface_clk",		gsbi1_p_clk.c,		"spi_qsd.0"), */
	CLK_LOOKUP("iface_clk",		gsbi1_p_clk.c,		"qup_i2c.1"), /* IDPower */
...
#else	/* npdc300058009 */
	/* Source the dsi1_esc_clk from the pxo */
