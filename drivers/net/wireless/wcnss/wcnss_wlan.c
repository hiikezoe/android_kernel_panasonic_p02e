...
#include <linux/delay.h>                                                        /* PMC-WLAN 2012.09.25 npdc300051998*/
...
#define PIL_GET_MAX_RETRY_NUM 2                                                 /* PMC-WLAN 2012.09.25 npdc300051998*/
static void wlan_wcnss_fatal(struct work_struct *);                             /* PMC-WLAN 2012.09.25 npdc300051998*/
static DECLARE_WORK(wlan_wcnss_fatal_work, wlan_wcnss_fatal);                   /* PMC-WLAN 2012.09.25 npdc300051998*/
...
wcnss_trigger_config(struct platform_device *pdev)
{
	...
	int retry=0;                                                                /* PMC-WLAN 2012.09.25 npdc300051998*/
...
#if 1                                                                           /* PMC-WLAN 2012.09.25 npdc300051998 start*/
	for(retry=0 ;retry <= PIL_GET_MAX_RETRY_NUM ; retry++)
	{
	...
	if(IS_ERR_OR_NULL(penv->pil))
	{
        schedule_work(&wlan_wcnss_fatal_work);
		goto fail_pil;
	}
#else                                                                           /* PMC-WLAN 2012.09.25 npdc300051998*/
	/* trigger initialization of the WCNSS */
	penv->pil = pil_get(WCNSS_PIL_DEVICE);
	if (IS_ERR(penv->pil)) {
		dev_err(&pdev->dev, "Peripheral Loader failed on WCNSS.\n");
...
#endif                                                                          /* PMC-WLAN 2012.09.25 npdc300051998 end*/
...
static void wlan_wcnss_fatal(struct work_struct *work)                          /* PMC-WLAN 2012.09.25 npdc300051998*/
{                                                                               /* PMC-WLAN 2012.09.25 npdc300051998*/
	panic(DEVICE ": Watchdog bite received from pil_get");                      /* PMC-WLAN 2012.09.25 npdc300051998*/
}                                                                               /* PMC-WLAN 2012.09.25 npdc300051998*/
