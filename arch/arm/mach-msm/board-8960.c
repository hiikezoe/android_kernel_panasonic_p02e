...
/* iDPower Temporary MOD start */
/* #define MSM_ION_SF_SIZE            0x0     */
#define MSM_ION_SF_SIZE		0x3E00000
/* iDPower Temporary MOD end */
...
static struct msm_otg_platform_data msm_otg_pdata = {
#if 0	/* IDP Disable USB Host Mode */
	.mode			= USB_OTG,
#else
	.mode			= USB_PERIPHERAL,
#endif
...
#define SYNAPTICS_INT_GPIO (11)
#define SYNAPTICS_POW_GPIO (4)
...
static void synaptics_dev_init(void)
{
	...
	/* Power */
	if (gpio_request(SYNAPTICS_POW_GPIO, "touch-power") < 0) {
		printk(KERN_ERR "can't get synaptics power control GPIO\n");
		return;
	}
	gpio_direction_output(SYNAPTICS_POW_GPIO, 1);
...
static int synaptics_power(int power_state)
{
	...
	case SYNAPTICS_POWER_OFF:
		gpio_set_value(SYNAPTICS_POW_GPIO, 0);
		msleep(10); /* Wait for stablizing */
		break;
	case SYNAPTICS_POWER_ON:
		gpio_set_value(SYNAPTICS_POW_GPIO, 1);
...
#endif
	&msm8960_device_qup_i2c_gsbi1,    /* IDPower */
	&msm_slim_ctrl,
...
// <SlimAV1> add S
static struct i2c_board_info flashled_info[] __initdata = {
	{
		I2C_BOARD_INFO("flashled", 0x30),
	},
};
// <SlimAV1> add E
...
static struct i2c_registry msm8960_i2c_devices[] __initdata = {
	...
	{
#if 0  /* <SlimAV1> patch START */
		I2C_LIQUID,
#else
		I2C_SURF | I2C_LIQUID,
#endif /* <SlimAV1> patch END   */
		MSM_8960_GSBI10_QUP_I2C_BUS_ID,
...
#define DMEM_RAM_CONSOLE_START  (0xBFF40000)
#endif
...
#else
	/* Temporarily to run without conditions for SlimAV1. */
#endif /* <SlimAV1> patch END   */
