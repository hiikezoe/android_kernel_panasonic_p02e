...
#define MIPI_VIDEO_TMD_HD_PANEL_NAME	"mipi_video_tmd_hd"
...
#ifndef CONFIG_FB_MSM_MIPI_DSI_TMD	/*<RUPY>*/
...
#endif	/* #ifndef CONFIG_FB_MSM_MIPI_DSI_TMD *//*<RUPY>*/
...
#ifdef CONFIG_FB_MSM_MIPI_DSI_TMD
static int mipi_dsi_tmd_panel_power(int on)
{
	static struct regulator *reg_l23, *reg_l2, *reg_l17;
	...
	if (on) {
		...
		rc = regulator_set_optimum_mode(reg_l17, 150000);
		if (rc < 0) {
...
#else
	ret = mipi_dsi_tmd_panel_power(on);
#endif  //CONFIG_FB_MSM_MIPI_DSI_TMD
	return ret;
}
...
static struct mipi_dsi_panel_platform_data tmd_pdata = {
	.gpio = tmd_gpio,
};

static struct platform_device mipi_dsi_tmd_panel_device = {
	.name = "mipi_tmd",
	.id = 0,
	.dev = {
		.platform_data = &tmd_pdata,
	}
};
#endif //CONFIG_FB_MSM_MIPI_DSI_TMD
...
#else
	platform_device_register(&mipi_dsi_tmd_panel_device);
#endif
